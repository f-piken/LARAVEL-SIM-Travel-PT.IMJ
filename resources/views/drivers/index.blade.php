...
@section('content')
<!-- page title -->
    <x-page-title title="Driver List" pagetitle="Drivers" />
    ...
    <div class="card" id="driverList">
        <div class="card-body">
            <div class="grid grid-cols-1 gap-5 mb-5 xl:grid-cols-2">
                        ...
                        <form action="{{ route('drivers.index') }}" method="GET">
                            <div class="flex border border-slate-200 rounded-md overflow-hidden">
                                <input type="text" name="search"
                                       ...
                                       placeholder="Search for drivers..." value="{{ $search }}" autocomplete="off">
                ...
                <div class="ltr:md:text-end rtl:md:text-start">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#showModal" data-modal-target="showModal"
                        ...
                        <i class="align-bottom ri-add-line me-1"></i> Add Driver
                    </button>
            ...
            <div class="overflow-x-auto">
                ...
                @endif
                <form action="{{ route('drivers.bulkDelete') }}" method="POST" id="bulkDeleteForm">
                    @csrf
                    @method('DELETE')
                    <table class="w-full whitespace-nowrap" id="driverTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-3.5 py-2.5 border-y border-slate-200">
                                    ...
                                    <form action="{{ route('drivers.destroy', $item->id) }}" method="POST" class="delete-form">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100 btn-delete">
