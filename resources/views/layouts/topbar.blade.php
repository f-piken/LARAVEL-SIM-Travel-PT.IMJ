            ...
            <div
                ...
                <div class="flex gap-3 ms-auto">
                    ...
                    <div class="relative flex items-center dropdown h-header">
                        <button type="button"
                            ...
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <div class="bg-pink-100 rounded-full">
                                    <img src="{{ URL::asset(Auth::user()->Employe->profile_photo_path) }}" alt=""
                        ...
                        <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem]"
                            aria-labelledby="dropdownMenuButton">
                            <h6 class="mb-2 text-sm font-normal text-slate-500">Welcome to Tailwick
                            </h6>
                            <a href="#!" class="flex gap-3 mb-3">
                                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                    <div class="relative inline-block shrink-0">
                                        <div class="rounded bg-slate-100">
                                            <img src="{{ URL::asset(Auth::user()->Employe->profile_photo_path) }}"
                ...
                <div class="flex gap-2 product">
                    ...
                    <div class="overflow-hidden grow">
                        ...
                        <div class="flex items-center mb-3">
                            ...
                            <div class="font-normal rtl:mr-1 ltr:ml-1 text-slate-500">(Fashion)</div>
                        </div>
                ...
                <div class="flex gap-2 product">
                    ...
                    <div class="overflow-hidden grow">
                        ...
                        <div class="flex items-center mb-3">
                            ...
                            <div class="font-normal rtl:mr-1 ltr:ml-1 text-slate-400">(Luggage)</div>
                        </div>
                        <div class="flex items-center justify-between gap-3">
                            <div class="inline-flex text-center input-step">
                                <button type="button"
                ...
                <div class="flex gap-2 product">
                    ...
                    <div class="overflow-hidden grow">
                        ...
                        <div class="flex items-center mb-3">
                            ...
                            <div class="font-normal rtl:mr-1 ltr:ml-1 text-slate-400">(Fashion)</div>
                        </div>
                        <div class="flex items-center justify-between gap-3">
                            <div class="inline-flex text-center input-step">
                                <button type="button"
