...
@section('content')
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                <div class="xl:col-span-7">
                    ...
                    <p class="mb-5 text-slate-500">Open the door to a wealth of resources and expert
                    ...
                    <div class="relative inline-block w-2/3">
                        <input type="text"
                            class="w-full py-2 pl-4 pr-8 form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
                            placeholder="Ask a question" autocomplete="off">
                        <i data-lucide="search"
                            class="inline-block size-4 absolute right-2.5 top-2.5 text-slate-400 fill-slate-100"></i>
                    </div>
                    <ul class="flex gap-2 mt-3">
                        <li><a href="#!"
                                class="px-2.5 py-0.5 text-xs font-medium rounded border bg-slate-100 border-slate-100 text-slate-500">Install
                                Vite</a></li>
                        <li><a href="#!"
                                class="px-2.5 py-0.5 text-xs font-medium rounded border bg-slate-100 border-slate-100 text-slate-500">React</a>
                        </li>
                        <li><a href="#!"
                                class="px-2.5 py-0.5 text-xs font-medium rounded border bg-slate-100 border-slate-100 text-slate-500">Angular</a>
                        </li>
                        <li><a href="#!"
                                class="px-2.5 py-0.5 text-xs font-medium rounded border bg-slate-100 border-slate-100 text-slate-500">Vue</a>
                        </li>
                    </ul>
                </div><!--end col-->
        ...
        <div>
            <div class="collapsible">
                ...
                <div class="hidden collapsible-content card">
                    <div class="card-body">
                        <p class="mb-3 text-slate-500">To install Tailwind CSS, you can use npm or yarn
            ...
            <div class="collapsible">
                ...
                <div class="collapsible-content card">
                    <div class="card-body">
                        <p class="mb-3 text-slate-500">To enable dark mode in Tailwind CSS, update your
                        ...
                        <p class="mb-3 text-slate-500">Using <code
    ...
    // ...
            ...
            <div class="collapsible">
                ...
                <div class="collapsible-content card">
                    <div class="card-body">
                        <p class="mb-3 text-slate-500">To get started with your first plugin, import
    ...
    plugins: [
        ...
        <div>
            <div class="collapsible">
                ...
                <div class="collapsible-content card">
                    <div class="card-body">
                        <p class="mb-3 text-slate-500">You can customize the <code
        ...
        plugins: [],
            ...
            <div class="collapsible">
                ...
                <div class="collapsible-content card">
                    <div class="card-body">
                        <p class="mb-3 text-slate-500">Tailwind CSS generates responsive variants for
