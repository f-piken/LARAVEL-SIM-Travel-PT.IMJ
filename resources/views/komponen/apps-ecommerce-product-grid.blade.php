    ...
    <div class="grid grid-cols-1 2xl:grid-cols-12 gap-x-5 ">
        ...
        <div class="2xl:col-span-9">
            <div class="flex flex-wrap items-center gap-2">
                ...
                <div class="flex gap-2 shrink-0 items-cente">
                    ...
                    <button type="button" id="listView"
                        class="flex items-center justify-center size-[37.5px] p-0 text-sky-500 btn bg-sky-100 hover:text-white hover:bg-sky-600 focus:text-white focus:bg-sky-600 [&.active]:text-white [&.active]:bg-sky-600"><i
                            data-lucide="list" class="size-4"></i></button>
                    <button type="button" id="gridView"
                        class="flex items-center justify-center size-[37.5px] p-0 text-sky-500 btn bg-sky-100 hover:text-white hover:bg-sky-600 focus:text-white focus:bg-sky-600 [&.active]:text-white [&.active]:bg-sky-600 active"><i
            ...
            <div class="flex items-center gap-3 mt-3">
                <span
                    class="px-2.5 py-0.5 text-sm font-medium rounded-full border bg-slate-100 border-slate-300 text-slate-500 inline-flex items-center">High
                    to Low <a href="#!"
                        class="transition text-slate-500 hover:text-slate-600"><i
                            data-lucide="x" class="size-3 ltr:ml-1 rtl:mr-1"></i></a></span>
                <span
                    class="px-2.5 py-0.5 text-sm font-medium rounded-full border bg-slate-100 border-slate-300 text-slate-500 inline-flex items-center">New
                    <a href="#!"
                        class="transition text-slate-500 hover:text-slate-600"><i
                            data-lucide="x" class="size-3 ltr:ml-1 rtl:mr-1"></i></a></span>
                <a href="#!"
                    class="px-2.5 py-0.5 text-sm font-medium rounded border bg-transparent border-transparent text-slate-500 transition hover:bg-slate-200">All
                    Clear</a>
            </div>
                ...
                <div class="card md:group-[.gridView]:flex relative">
                    <div class="relative group-[.gridView]:static p-8 group-[.gridView]:p-5">
                        <a href="#!" class="absolute group/item toggle-button top-6 ltr:right-6 rtl:left-6 active"><i
                                data-lucide="heart"
                                class="size-5 text-slate-400 fill-slate-200 transition-all duration-150 ease-linear group-[.active]/item:text-red-500 group-[.active]/item:fill-red-200 group-hover/item:text-red-500 group-hover/item:fill-red-200"></i></a>
                        <div
                            class="group-[.gridView]:p-3 group-[.gridView]:bg-slate-100 group-[.gridView]:inline-block rounded-md">
                    ...
                    <div
                        ...
                        <div class="group-[.gridView]:grow">
                            ...
                            <h5 class="mt-4 text-16">$674.12 <small
                                    class="font-normal line-through text-slate-500">784.99</small></h5>
                        </div>

                        <div class="flex items-center gap-2 mt-4 group-[.gridView]:mt-0 group-[.gridView]:self-end">
                            <button type="button"
                                class="w-full bg-white border-dashed text-slate-500 btn border-slate-500 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-600 focus:text-slate-600 focus:bg-slate-50 focus:border-slate-600 active:text-slate-600 active:bg-slate-50 active:border-slate-600"><i
                    ...
                    <div
                        ...
                        <div class="group-[.gridView]:grow">
                            ...
                            <h5 class="mt-4 text-16">$362.21 <small
                                    class="font-normal line-through text-slate-500">599.99</small></h5>
                        </div>
                    ...
                    <div
                        ...
                        <div class="group-[.gridView]:grow">
                            ...
                            <h5 class="mt-4 text-16">$249.99 <small
                                    class="font-normal line-through text-slate-500">399.99</small></h5>
                        </div>
                    ...
                    <div
                        ...
                        <div class="group-[.gridView]:grow">
                            ...
                            <h5 class="mt-4 text-16">$145 <small
                                    class="font-normal line-through text-slate-500">299.99</small></h5>
                        </div>
