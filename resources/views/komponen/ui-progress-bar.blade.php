...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="grid grid-cols-1 gap-x-4 xl:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="w-full bg-slate-200 rounded-full h-2.5">
                        <div class="bg-slate-500 h-2.5 rounded-full" style="width: 100%"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 gap-x-4 xl:grid-cols-2">
        <div class="card">
            <div class="card-body">
                ...
                <div class="pt-2">
                    <div class="w-full bg-slate-200 rounded-full h-2.5 mb-7">
                    ...
                    <div class="w-full bg-slate-200 rounded-full h-2.5 mb-0">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="w-full bg-slate-200 rounded-full h-2.5">
                        <div class="bg-slate-500 h-2.5 rounded-full animate-progress" style="width: 100%">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="w-full h-1.5 mb-4 rounded-full bg-slate-200">
                <div class="h-1.5 rounded-full bg-custom-500" style="width: 25%"></div>
            </div>
            <div class="w-full h-2 mb-4 rounded-full bg-slate-200">
            ...
            <div class="w-full h-3.5 mb-4 rounded-full bg-slate-200">
                <div class="h-3.5 rounded-full bg-custom-500" style="width: 25%"></div>
            </div>
            <div class="w-full h-5 mb-4 rounded-full bg-slate-200">
                <div class="h-5 rounded-full bg-custom-500" style="width: 25%"></div>
            </div>
            <div class="w-full h-6 rounded-full bg-slate-200">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="w-full h-5 rounded-full bg-slate-200">
