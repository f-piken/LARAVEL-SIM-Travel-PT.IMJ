...
@section('content')
    <!-- page title -->
    <x-page-title title="Datatable" pagetitle="Tables" />
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-4 text-15">Row Borders</h6>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-4 text-15">Alternative Pagination</h6>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-4 text-15">Hidden Columns</h6>
            <table id="hiddenColumns" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Position</th>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-4 text-15">Row Selection & Deletion (single row)</h6>
            <div class="mb-3"><button id="deleteButton"
    ...
    <div class="card">
        <div class="card-body">
                    ...
                    <tr>
                        <td>
                            <div class="grid grid-cols-2 gap-3 mb-3">
                                <div>
                                    <label for="min" class="inline-block mb-2 text-base font-medium">Minimum
                                        Age:</label>
                                    <input
                                        ...
                                        type="text" id="min" name="min" placeholder="Enter age min">
                                </div>
                                <div>
                                    <label for="max" class="inline-block mb-2 text-base font-medium">Maximum
                                        Age:</label>
                                    <input
                                        class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
                                        type="text" id="max" name="max" placeholder="Enter age max">
                                </div>
                            </div>
                        </td>
                    </tr>
            ...
            <table id="customFiltering" class="display" style="width:100%">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Position</th>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-4 text-15">Show / Hide Columns Dynamically</h6>
            <h6 class="mb-3">Toggle column:</h6>
            <div class="flex flex-wrap gap-2 mb-3">
                <button
                    class="text-slate-500 btn bg-slate-200 border-slate-200 hover:text-slate-600 hover:bg-slate-300 hover:border-slate-300 focus:text-slate-600 focus:bg-slate-300 focus:border-slate-300 focus:ring focus:ring-slate-100 active:text-slate-600 active:bg-slate-300 active:border-slate-300 active:ring active:ring-slate-100"
                    data-column="0">Name</button>
                <button
                    class="text-slate-500 btn bg-slate-200 border-slate-200 hover:text-slate-600 hover:bg-slate-300 hover:border-slate-300 focus:text-slate-600 focus:bg-slate-300 focus:border-slate-300 focus:ring focus:ring-slate-100 active:text-slate-600 active:bg-slate-300 active:border-slate-300 active:ring active:ring-slate-100"
                    data-column="1">Position</button>
                <button
                    class="text-slate-500 btn bg-slate-200 border-slate-200 hover:text-slate-600 hover:bg-slate-300 hover:border-slate-300 focus:text-slate-600 focus:bg-slate-300 focus:border-slate-300 focus:ring focus:ring-slate-100 active:text-slate-600 active:bg-slate-300 active:border-slate-300 active:ring active:ring-slate-100"
                    data-column="2">Office</button>
                <button
                    class="text-slate-500 btn bg-slate-200 border-slate-200 hover:text-slate-600 hover:bg-slate-300 hover:border-slate-300 focus:text-slate-600 focus:bg-slate-300 focus:border-slate-300 focus:ring focus:ring-slate-100 active:text-slate-600 active:bg-slate-300 active:border-slate-300 active:ring active:ring-slate-100"
                    data-column="3">Age</button>
                <button
                    class="text-slate-500 btn bg-slate-200 border-slate-200 hover:text-slate-600 hover:bg-slate-300 hover:border-slate-300 focus:text-slate-600 focus:bg-slate-300 focus:border-slate-300 focus:ring focus:ring-slate-100 active:text-slate-600 active:bg-slate-300 active:border-slate-300 active:ring active:ring-slate-100"
                    data-column="4">Start date</button>
                <button
                    class="text-slate-500 btn bg-slate-200 border-slate-200 hover:text-slate-600 hover:bg-slate-300 hover:border-slate-300 focus:text-slate-600 focus:bg-slate-300 focus:border-slate-300 focus:ring focus:ring-slate-100 active:text-slate-600 active:bg-slate-300 active:border-slate-300 active:ring active:ring-slate-100"
                    data-column="5">Salary</button>
            </div>
