...
@section('content')
    ...
    <div class="grid grid-cols-1 2xl:grid-cols-12 gap-x-5">
        <div class="2xl:col-span-3">
            <div class="card">
                <div class="card-body">
                    <div
                        class="flex items-center justify-center size-12 bg-purple-100 rounded-md ltr:float-right rtl:float-left">
                        <i data-lucide="truck" class="text-purple-500 fill-purple-200"></i>
                    </div>
                    <h6 class="mb-4 text-15">Shipping Details</h6>

                    <h6 class="mb-1">Pauline Hylton</h6>
                    <p class="mb-1 text-slate-500">1235 Crossing Meadows Dr, Onalaska</p>
                    <p class="text-slate-500">West Virginia, USA</p>
                </div>
            </div>
        </div><!--end col-->
        <div class="2xl:col-span-3">
            <div class="card">
                <div class="card-body">
                    <div
                        class="flex items-center justify-center size-12 bg-orange-100 rounded-md ltr:float-right rtl:float-left">
                        <i data-lucide="credit-card" class="text-orange-500 fill-orange-200"></i>
                    </div>
        ...
        <div class="2xl:col-span-3">
            <div class="card">
                <div class="card-body">
                    <div
                        class="flex items-center justify-center size-12 rounded-md ltr:float-right rtl:float-left bg-sky-100">
                        <i data-lucide="circle-dollar-sign" class="text-sky-500 fill-sky-200"></i>
                    </div>
                    <h6 class="mb-4 text-15">Payment Details</h6>

                    <h6 class="mb-1">ID: #TSD456DF41SD5</h6>
                    <p class="mb-1 text-slate-500">Payment Method: <b>Credit Card</b></p>
                    <p class="mb-1 text-slate-500">Card Number: <b>xxxx xxxx xxxx 1501</b></p>
                </div>
            </div>
        </div><!--end col-->
        <div class="2xl:col-span-3">
            <div class="card">
                <div class="card-body">
                    <div class="size-12 bg-yellow-100 rounded-md ltr:float-right rtl:float-left">
                    ...
                    <h6 class="mb-1">Pauline Hylton</h6>
                    <p class="mb-1 text-slate-500">pauline@tailwick.com</p>
                    <p class="text-slate-500">+(78) 120 4843 4714</p>
                </div>
            </div>
        </div><!--end col-->
    </div><!--end grid-->
    ...
    <div class="grid grid-cols-1 2xl:grid-cols-12 gap-x-5">
                ...
                <div>
                    <div class="card">
                        <div class="text-center card-body">
                            ...
                            <p class="uppercase text-slate-500">Order ID</p>
                        </div>
                    </div>
                </div><!--end col-->
                <div>
                    <div class="card">
                        <div class="text-center card-body">
                            ...
                            <p class="uppercase text-slate-500">Order Date</p>
                        </div>
                    </div>
                </div><!--end col-->
                <div>
                    <div class="card">
                        <div class="text-center card-body">
                            ...
                            <p class="uppercase text-slate-500">Delivery Date</p>
                        </div>
                    </div>
                </div><!--end col-->
                <div>
                    <div class="card">
                        <div class="text-center card-body">
                            ...
                            <p class="uppercase text-slate-500">Order Amount</p>
                        </div>
                    </div>
                </div><!--end col-->
                <div>
                    <div class="card">
                        <div class="text-center card-body">
                            ...
                            <p class="uppercase text-slate-500">Order Status</p>
                        </div>
                    </div>
                </div><!--end col-->
            </div><!--end grid-->
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <tbody>
                                <tr>
                                    <td
                                        class="px-3.5 py-4 border-b border-dashed first:pl-0 last:pr-0 border-slate-200">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="grow">
                                                ...
                                                <p class="text-slate-500">$149.99 x 02</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td
                                        class="px-3.5 py-4 border-b border-dashed first:pl-0 last:pr-0 border-slate-200 ltr:text-right rtl:text-left">
                                        $299.98</td>
                                </tr>
                                <tr>
                                    <td
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="grow">
                                                ...
                                                <p class="text-slate-500">$362.21 x 1</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td
                                    ...
                                    <td
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="grow">
                                                ...
                                                <p class="text-slate-500">$89.99 x 03</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    <td class="px-3.5 pt-4 pb-3 first:pl-0 last:pr-0 text-slate-500">
                                        Sub Total
                                    </td>
                                ...
                                <tr>
                                    <td class="px-3.5 py-3 first:pl-0 last:pr-0 text-slate-500">
                                        Estimated Tax (18%)
                                    </td>
                                ...
                                <tr class="font-semibold">
                                    <td class="px-3.5 pt-3 first:pl-0 last:pr-0 text-slate-500">
                                        Total Amount (USD)
                                    </td>
                    ...
                    <div>
                        <div
                            ...
                            <div class="flex gap-4">
                                <div class="grow">
                                    <h6 class="mb-2 text-gray-800 text-15">Order Placed</h6>
                                    <p class="text-gray-400">Your order has been successfully submitted.
                                    </p>
                                </div>
                                <p class="text-sm text-gray-400 shrink-0">02 Nov, 2023</p>
                            </div>
                        </div>
                        <div
                            class="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l rtl:before:border-r ltr:before:left-[0.1875rem] rtl:before:right-[0.1875rem] before:border-slate-200 [&.done]:before:border-custom-500 before:top-1.5 before:-bottom-1.5 after:absolute after:size-2 after:bg-white after:border after:border-slate-200 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 last:before:hidden [&.done]:after:bg-custom-500 [&.done]:after:border-custom-500 done">
                            <div class="flex gap-4">
                                <div class="grow">
                                    <h6 class="mb-2 text-gray-800 text-15">Order Processing</h6>
                                    <p class="text-gray-400">Once the order is received, it goes through
                        ...
                        <div
                            ...
                            <div class="flex gap-4">
                                <div class="grow">
                                    <h6 class="mb-2 text-gray-800 text-15">Shipped Order</h6>
                                    <p class="text-gray-400">The order is shipped out to the customer's
                                        designated delivery address.</p>
                                </div>
                                <p class="text-sm text-gray-400 shrink-0">04 Nov, 2023</p>
                            </div>
                        </div>
                        <div
                            class="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l rtl:before:border-r ltr:before:left-[0.1875rem] rtl:before:right-[0.1875rem] before:border-slate-200 [&.done]:before:border-custom-500 before:top-1.5 before:-bottom-1.5 after:absolute after:size-2 after:bg-white after:border after:border-slate-200 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 last:before:hidden [&.done]:after:bg-custom-500 [&.done]:after:border-custom-500 done">
                            <div class="flex gap-4">
                                <div class="grow">
                                    <h6 class="mb-2 text-gray-800 text-15">Out for Delivery</h6>
                                    <p class="text-gray-400">This status indicates that the order is
                                        currently out for delivery by the shipping or courier company.</p>
                                </div>
                                <p class="text-sm text-gray-400 shrink-0">06 Nov, 2023</p>
                            </div>
                        </div>
                        <div
                            class="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l rtl:before:border-r ltr:before:left-[0.1875rem] rtl:before:right-[0.1875rem] before:border-slate-200 [&.done]:before:border-custom-500 before:top-1.5 before:-bottom-1.5 after:absolute after:size-2 after:bg-white after:border after:border-slate-200 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 last:before:hidden [&.done]:after:bg-custom-500 [&.done]:after:border-custom-500 done">
                            <div class="flex gap-4">
                                <div class="grow">
                                    <h6 class="mb-2 text-gray-800 text-15">Delivered</h6>
                                    <p class="text-gray-400">Finally, when the order successfully
                                        reaches the customer's address and is handed over, the status changes to
                                        "Delivered."</p>
                                </div>
                                <p class="text-sm text-gray-400 shrink-0">09 Nov, 2023</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="2xl:col-span-3">
            <div class="card">
                <div class="card-body">
                    <h6 class="mb-3 text-gray-800 text-15">Documents</h6>
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <tbody>
                                <tr>
                ...
                <div class="card-body">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="grow">
                            ...
                            <p class="text-slate-500">ID: EDTW1400457854</p>
                        </div>
                    </div>
                </div>
            </div>
