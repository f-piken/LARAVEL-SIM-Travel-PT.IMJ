                    ...
                    <form action="#!">
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                            <div class="xl:col-span-6">
                                ...
                                <p class="mt-1 text-sm text-slate-400">Do not exceed 20 characters when
                            ...
                            <div class="xl:col-span-6">
                                ...
                                <p class="mt-1 text-sm text-slate-400">Code will be generated
                                    automatically</p>
                            </div><!--end col-->
                            ...
                            <div class="xl:col-span-6">
                                ...
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <div>
                                        <a href="#!"
                                            class="flex items-center justify-center size-5 border rounded-sm border-slate-200"><i
                                ...
                                <div class="flex flex-wrap items-center gap-2">
                                    <div>
                                        ...
                                        <label for="selectSizeXS"
                                            class="flex items-center justify-center size-10 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">XS</label>
                                    </div>
                                    <div>
                                        <input id="selectSizeS" class="hidden peer" type="checkbox" value="S"
                                            name="selectSize" checked>
                                        <label for="selectSizeS"
                                            class="flex items-center justify-center size-10 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">S</label>
                                    </div>
                                    <div>
                                        <input id="selectSizeM" class="hidden peer" type="checkbox" value="M"
                                            name="selectSize">
                                        <label for="selectSizeM"
                                            class="flex items-center justify-center size-10 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">M</label>
                                    </div>
                                    <div>
                                        <input id="selectSizeL" class="hidden peer" type="checkbox" value="L"
                                            name="selectSize">
                                        <label for="selectSizeL"
                                            class="flex items-center justify-center size-10 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">L</label>
                                    </div>
                                    <div>
                                        <input id="selectSizeXL" class="hidden peer" type="checkbox" value="XL"
                                            name="selectSize">
                                        <label for="selectSizeXL"
                                            class="flex items-center justify-center size-10 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">XL</label>
                                    </div>
                                    <div>
                                        <input id="selectSize2XL" class="hidden peer" type="checkbox" value="2XL"
                                            name="selectSize">
                                        <label for="selectSize2XL"
                                            class="flex items-center justify-center size-10 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">2XL</label>
                                    </div>
                                    <div>
                                        <input id="selectSize3XL" class="hidden peer" type="checkbox" value="3XL"
                                            name="selectSize">
                                        <label for="selectSize3XL"
                                            class="flex items-center justify-center size-10 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">3XL</label>
                                    </div>
                                </div>
                            </div><!--end col-->
                            <div class="lg:col-span-2 xl:col-span-12">
                                ...
                                <div
                                    ...
                                    <div class="w-full py-5 text-lg text-center dz-message needsclick">
                                        ...
                                        <h5 class="mb-0 font-normal text-slate-500 text-15">Drag and
                                    ...
                                    <li class="mt-5" id="dropzone-preview-list2">
                                        ...
                                        <div class="border rounded border-slate-200">
                                            <div class="p-2 text-center">
                                                <div>
                                                    <div
                                                        class="p-2 mx-auto rounded-md size-14 bg-slate-100">
                        ...
                        <div class="flex justify-end gap-2 mt-4">
                            <button type="reset"
                                class="text-red-500 bg-white btn hover:text-red-500 hover:bg-red-100 focus:text-red-500 focus:bg-red-100 active:text-red-500 active:bg-red-100">Reset</button>
                            <button type="submit"
        ...
        <div class="xl:col-span-3">
            <div class="card sticky top-[calc(theme('spacing.header')_*_1.3)]">
                <div class="card-body">
                    ...
                    <div class="px-5 py-8 rounded-md bg-sky-50">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-slate-500">Men's Fashion</p>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <div>
                            ...
                            <label for="selectSizePreXS"
                                class="flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">XS</label>
                        </div>
                        <div>
                            <input id="selectSizePreS" class="hidden peer" type="checkbox" value="S"
                                name="selectSizePre">
                            <label for="selectSizePreS"
                                class="flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">S</label>
                        </div>
                        <div>
                            <input id="selectSizePreM" class="hidden peer" type="checkbox" value="M"
                                name="selectSizePre">
                            <label for="selectSizePreM"
                                class="flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">M</label>
                        </div>
                        <div>
                            <input id="selectSizePreL" class="hidden peer" type="checkbox" value="L"
                                name="selectSizePre">
                            <label for="selectSizePreL"
                                class="flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">L</label>
                        </div>
                        <div>
                            <input id="selectSizePreXL" class="hidden peer" type="checkbox" value="XL"
                                name="selectSizePre">
                            <label for="selectSizePreXL"
                                class="flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">XL</label>
                        </div>
                    </div>
                    <div class="flex gap-2 mt-4">
                        <button type="button"
                            class="w-full bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600">Create
                            Products</button>
                        <button type="button"
                            class="w-full text-white bg-purple-500 border-purple-500 btn hover:text-white hover:bg-purple-600 hover:border-purple-600 focus:text-white focus:bg-purple-600 focus:border-purple-600 focus:ring focus:ring-purple-100 active:text-white active:bg-purple-600 active:border-purple-600 active:ring active:ring-purple-100">Draft</button>
                    </div>
                </div>
            </div><!--end card-->
        </div><!--end col-->
