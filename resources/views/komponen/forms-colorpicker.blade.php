...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-3">
        <div class="card">
            <div class="card-body">
                <h6 class="mb-1 text-gray-800 text-15">Monolith Demo</h6>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-1 text-gray-800 text-15">Classic Demo</h6>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-1 text-gray-800 text-15">Nano Demo</h6>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-1 text-gray-800 text-15">Option Demo</h6>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-1 text-gray-800 text-15">Switches</h6>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-1 text-gray-800 text-15">Picker with Opacity & Hue</h6>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-1 text-gray-800 text-15">Picker with Input</h6>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-1 text-gray-800 text-15">Color Format</h6>
