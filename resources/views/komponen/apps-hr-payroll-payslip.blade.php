        ...
        <div class="relative card 2xl:col-span-8 2xl:col-start-3">
            <div class="p-8">
                ...
                <div class="text-center">
                    <h5
                        class="relative before:absolute before:h-[1px] before:inset-x-0 before:-bottom-2.5 inline-block before:bg-gradient-to-r before:from-white before:via-custom-500 before:to-white">
                        Salary Slip</h5>
                </div>

                <div class="mt-16">
                    <p class="mb-2 text-slate-500">Employee ID: <span
                            class="font-semibold text-slate-800">#TWE1001524</span></p>
                    <p class="mb-2 text-slate-500">Employee Name: <span
                            class="font-semibold text-slate-800">Patricia Garcia</span></p>
                    <p class="mb-2 text-slate-500">Experience: <span
                            class="font-semibold text-slate-800">2 Year</span></p>
                    <p class="text-slate-500">Create Date: <span
                            class="font-semibold text-slate-800">08 Oct 2023</span></p>
                </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="px-3.5 py-2.5 border border-transparent"><span
                                        class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-green-100 border-green-200 text-green-500">Paid</span>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="grid grid-cols-1 mt-10 2xl:grid-cols-12">
                    <div class="2xl:col-span-5">
                        <p class="mb-2 text-slate-500">For any inquiries, please contact us at +(252)
                            0123 456 7890 or reach out via email at tailwick@themesdesign.com.</p>
                        <p class="mb-2 text-slate-500">Best Regards,</p>
                        <p class="mb-2 text-slate-500">Themesdesign</p>
                        <p class="text-slate-500">Founder & CEO: <span
                                class="font-semibold text-slate-800">Paula Keenan</span></p>
                    </div>
