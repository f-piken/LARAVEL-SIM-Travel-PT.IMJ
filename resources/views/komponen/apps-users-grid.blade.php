...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
        <div class="card">
            <div class="card-body">
                <div
                    class="relative flex items-center justify-center size-16 mx-auto text-lg rounded-full bg-slate-100">
                    <img src="{{ URL::asset('build/images/users/avatar-1.png') }}" alt=""
                        class="size-16 rounded-full">
                    <span
                        class="absolute size-3 bg-green-400 border-2 border-white rounded-full bottom-1 ltr:right-1 rtl:left-1"></span>
                </div>
                <div class="mt-4 text-center">
                    <h5 class="mb-1 text-16"><a href="{{ url('pages-account') }}">Paula Keenan</a></h5>
                    <p class="mb-3 text-slate-500">@Admin</p>
                    <p class="text-slate-500">748 Luettgen Plain Suite South Winstonfort, NM</p>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mb-3 text-slate-500">@Subscriber</p>
                    <p class="text-slate-500">125 Ortiz Camp Suite 471 Rippinport, US</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mb-3 text-slate-500">@Editor</p>
                    <p class="text-slate-500">8716 Dell Manors New Ahmedmouth, WI</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mb-3 text-slate-500">@Developer</p>
                    <p class="text-slate-500">617 Powlowski Crossroad Apt. 716 New Victoria</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
            ...
            <div class="card-body">
                <div
                    ...
                    <img src="{{ URL::asset('build/images/users/avatar-4.png') }}" alt=""
                        class="size-16 rounded-full">
                    <span
                        class="absolute size-3 bg-red-400 border-2 border-white rounded-full bottom-1 right-1"></span>
                </div>
                <div class="mt-4 text-center">
                    <h5 class="mb-1 text-16"><a href="{{ url('pages-account') }}">Aurore Maggio</a></h5>
                    <p class="mb-3 text-slate-500">@Subscriber</p>
                    <p class="text-slate-500">8751 Boyer Courts Suite 532 West Fletcherside</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mb-3 text-slate-500">@Editor</p>
                    <p class="text-slate-500">32 Maidstone Road WELLSBOROUGH</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mb-3 text-slate-500">@Subscriber</p>
                    <p class="text-slate-500">431 Elk Rd Little Ticonderoga, NY</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mb-3 text-slate-500">@Subscriber</p>
                    <p class="text-slate-500">0816 Bradford Alley Lake Adamfort, ME</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mb-3 text-slate-500">@Author</p>
                    <p class="text-slate-500">99614 Pollich Extension Apt. 938 South Alf, GA</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mb-3 text-slate-500">@Subscriber</p>
                    <p class="text-slate-500">755 Kody Plaza Apt. 138 East Reinholdberg, AR</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mb-3 text-slate-500">@Author</p>
                    <p class="text-slate-500">895 Camylle Tunnel Lake Chasity, SC</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mb-3 text-slate-500">@Subscriber</p>
                    <p class="text-slate-500">75, Deccan Gymkhana, Alwar</p>
                </div>
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 grow"><i
