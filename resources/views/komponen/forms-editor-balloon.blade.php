...
@section('content')
    <!-- page title -->
    <x-page-title title="Balloon Editor" pagetitle="Forms" />

    <div class="px-4 py-3 mb-4 text-sm text-red-500 border border-transparent rounded-md bg-red-50">
        Notes: <a href="{{ url('https://ckeditor.com/docs/ckeditor5/latest/examples/builds/balloon-editor') }}"
            class="font-medium underline">https://ckeditor.com/docs/ckeditor5/latest/examples/builds/balloon-editor.html</a>
        more details
    </div>
...
@endsection
@push('scripts')
    <script src="{{ URL::asset('build/libs/@ckeditor/ckeditor5-build-balloon/build/ckeditor.js') }}"></script>

    <script src="{{ URL::asset('build/js/pages/form-editor-balloon.init.js') }}"></script>
