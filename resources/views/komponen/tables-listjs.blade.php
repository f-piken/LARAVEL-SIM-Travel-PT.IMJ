        ...
        <div class="card-body">
            <div class="grid grid-cols-1 gap-5 mb-5 xl:grid-cols-2">
                ...
                <div class="ltr:md:text-end rtl:md:text-start">
                    ...
                    <button type="button"
                        class="text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100"
            ...
            <div class="overflow-x-auto">
                <table class="w-full whitespace-nowrap" id="customerTable">
                    <thead class="bg-slate-100">
                        <tr>
                            ...
                            <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 ltr:text-left rtl:text-right"
                    ...
                    <tbody class="list form-check-all">
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 id"
                                style="display:none;"><a href="javascript:void(0);"
                                    class="fw-medium link-primary id">#VZ2101</a></td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">Mary
                                Cousar</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 email">
                                marycousar@tailwick.com</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 phone">580-464-4694</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 date">06 Apr, 2021</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 status"><span
                                    class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-green-100 border-transparent text-green-500 text-uppercase">Active</span>
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <div class="flex gap-2">
                                    <div class="edit">
                                        <button data-modal-target="showModal"
                                            class="py-1 text-xs text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 edit-item-btn">Edit</button>
                                    </div>
                                    <div class="remove">
                                        <button data-modal-target="deleteRecordModal" id="delete-record" class="py-1 text-xs text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100 remove-item-btn">Remove</button>
                                    </div>
                                </div>
                            </td>
                        </tr>
                ...
                <div class="noresult" style="display: none">
                    <div class="text-center p-7">
                        ...
                        <p class="mb-0 text-slate-500">We've searched more than 150+ Orders We did not
                ...
                <form class="tablelist-form">
                    ...
                    <div class="flex justify-end gap-2">
                        <button type="button" data-modal-close="showModal"
                            class="text-white btn bg-slate-500 border-slate-500 hover:text-white hover:bg-slate-600 hover:border-slate-600 focus:text-white focus:bg-slate-600 focus:border-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:border-slate-600 active:ring active:ring-slate-100"
