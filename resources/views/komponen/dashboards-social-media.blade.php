        ...
        <div class="col-span-12 lg:col-span-5 xl:col-span-3 shrink-0 lg:block">
            <div class="card">
                <div class="card-body">
                    <div class="flex items-center gap-3 mb-5">
                        <div class="rounded-full bg-slate-100 shrink-0">
                        ...
                        <div class="grow">
                            <h6 class="mb-1 text-15">Paula Keenan <i data-lucide="badge-check"
                                    class="inline-block size-4 text-sky-500 fill-sky-100"></i></h6>
                            <p class="text-slate-500">@paulak145</p>
                        </div>
                    </div>
                    <div
                        class="grid grid-cols-1 text-center divide-y sm:divide-y-0 sm:divide-x sm:grid-cols-3 divide-slate-200 divide-dashed rtl:divide-x-reverse">
                        <div class="py-3 sm:py-0 sm:px-3">
                            <h6>489</h6>
                            <p class="text-slate-500">Posts</p>
                        </div>
                        <div class="py-3 sm:py-0 sm:px-3">
                            <h6>4.6k</h6>
                            <p class="text-slate-500">Follower</p>
                        </div>
                        <div class="py-3 sm:py-0 sm:px-3">
                            <h6>159</h6>
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="flex flex-col w-full gap-2 mb-4 text-sm font-medium shrink-0 nav-tabs">
                        <li class="group grow active">
                            <a href="{{ url('dashboards-social-media') }}"
                                class="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]"><i
                    ...
                    <p class="mb-4 text-slate-500">Suggestion Pages</p>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <a href="#!" class="relative">
                            <img src="{{ URL::asset('build/images/users/avatar-2.png') }}" alt=""
                                class="h-10 border rounded-full border-slate-200">
                            <span
        ...
        <div class="col-span-12 lg:col-span-7 xl:col-span-9 2xl:col-span-6">
                    ...
                    <div class="w-full" data-simplebar>
                        <div class="flex gap-4">
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                ...
                                <div
                                    class="size-16 mx-auto rounded-full bg-pink-100 outline-1 outline outline-slate-200 outline-offset-[3px] group-[.active]:outline-custom-500 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-1.png') }}" alt=""
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="size-16 mx-auto rounded-full bg-sky-100 outline-1 outline outline-slate-200 outline-offset-[3px] group-[.active]:outline-custom-500 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-2.png') }}" alt=""
                                        class="size-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="size-16 mx-auto rounded-full bg-slate-100 outline-1 outline outline-slate-200 outline-offset-[3px] group-[.active]:outline-custom-500 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-3.png') }}" alt=""
                                        class="size-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="size-16 mx-auto rounded-full bg-yellow-100 outline-1 outline outline-slate-200 outline-offset-[3px] group-[.active]:outline-custom-500 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-4.png') }}" alt=""
                                        class="size-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="size-16 mx-auto rounded-full bg-emerald-100 outline-1 outline outline-slate-200 outline-offset-[3px] group-[.active]:outline-custom-500 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-5.png') }}" alt=""
                                        class="size-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="size-16 mx-auto rounded-full bg-purple-100 outline-1 outline outline-slate-200 outline-offset-[3px] group-[.active]:outline-custom-500 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-6.png') }}" alt=""
                                        class="size-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="size-16 mx-auto rounded-full bg-custom-100 outline-1 outline outline-slate-200 outline-offset-[3px] group-[.active]:outline-custom-500 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-7.png') }}" alt=""
                                        class="size-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="size-16 mx-auto rounded-full bg-green-100 outline-1 outline outline-slate-200 outline-offset-[3px] group-[.active]:outline-custom-500 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-8.png') }}" alt=""
                                        class="size-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="size-16 mx-auto rounded-full bg-cyan-100 outline-1 outline outline-slate-200 outline-offset-[3px] group-[.active]:outline-custom-500 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-10.png') }}" alt=""
                                        class="size-16 rounded-full">
                                </div>
                            ...
                            <a href="#!" class="block w-20 px-1 py-2 group">
                                <div
                                    class="size-16 mx-auto rounded-full bg-slate-100 outline-1 outline outline-slate-200 outline-offset-[3px] group-[.active]:outline-custom-500">
                                    <img src="{{ URL::asset('build/images/users/avatar-3.png') }}" alt=""
                                        class="size-16 rounded-full">
                                </div>
                                <h6 class="mt-2 font-normal truncate">@christina</h6>
                ...
                <div class="card-body">
                        ...
                        <ul class="flex gap-3 grow">
                            <li>
                                <a href="#!"><i data-lucide="video"
                                        ...
                                        class="align-middle text-slate-500">Live Video</span></a>
                            </li>
                            <li>
                                <a href="#!" data-modal-target="imagesVideoPostModal"><i data-lucide="image"
                                        ...
                                        class="align-middle text-slate-500">Image/Video</span></a>
                            </li>
                            <li>
                                <a href="#!" data-modal-target="eventModal"><i data-lucide="calendar-days"
                                        ...
                                        class="align-middle text-slate-500">Event</span></a>
                            </li>
                            <li>
                                <a href="#!"><i data-lucide="at-sign"
                                        class="inline-block size-4 ltr:mr-1 text-sky-500 rtl:ml-1"></i> <span
                                        class="align-middle text-slate-500">Mention</span></a>
                            </li>
                        </ul>
                    ...
                    <form action="#!">
                        <div class="flex gap-3 mt-4">
                            <div class="bg-pink-100 rounded-full size-9 shrink-0">
                                <img src="{{ URL::asset('build/images/users/avatar-1.png') }}" alt=""
            ...
            <div class="card">
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-5">
                        ...
                        <div class="grow">
                            <h6 class="mb-1 text-15"><a href="#!"
                                    class="transition-all duration-200 ease-linear hover:text-custom-500">Frances
                                    Zboncak</a> -<small class="ml-1 font-normal text-slate-500">25
                                    min</small></h6>
                            <p class="text-slate-500">Web Developer at <a href="#!"
                                    class="underline">Themesdesign</a></p>
                        </div>
                        <div class="flex items-center gap-2 mt-4 shrink-0 md:mt-4">
                            <button type="button"
                                class="group/item toggle-button active px-2 py-1.5 text-xs bg-white border-dashed text-sky-500 btn border-sky-500 hover:text-sky-500 hover:bg-sky-50 hover:border-sky-600 focus:text-sky-600 focus:bg-sky-50 focus:border-sky-600 active:text-sky-600 active:bg-sky-50 active:border-sky-600">
                            ...
                            <div class="relative dropdown">
                                <button
                                    class="dropdown-toggle flex items-center justify-center size-[30px] p-0 bg-white text-sky-500 btn hover:text-sky-500 hover:bg-sky-100 focus:text-sky-500 focus:bg-sky-100 active:text-sky-500 active:bg-sky-100"
                ...
                <div class="card-body">
                    ...
                    <div class="mt-5">
                        <div class="flex gap-3">
                            <div class="bg-yellow-100 rounded-full size-9 shrink-0">
                                <img src="{{ URL::asset('build/images/users/avatar-5.png') }}" alt=""
                                    class="rounded-full size-9">
                            </div>
                            <div class="grow">
                                <div class="p-3 rounded-md bg-slate-100">
                                    <h6 class="mb-3 text-15"><a href="#!">@bertha34</a> - <span
                                            class="text-sm font-normal text-slate-500">14 June,
                                            2023</span></h6>
                                    ...
                                    <div class="flex items-center gap-2 mt-4">
                                        <a href="#!"
                                            class="px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-slate-200 text-slate-500 transition hover:bg-slate-200">Like
                                            (3)</a>
                                        <a href="#!"
                                            class="px-2.5 py-0.5 text-xs font-medium rounded border bg-white border-slate-200 text-slate-500 transition hover:bg-slate-200">Reply</a>
                                    </div>
                                </div>
                                <div class="flex gap-3 mt-4">
                                    <div class="bg-green-100 rounded-full size-9 shrink-0">
                                        <img src="{{ URL::asset('build/images/users/avatar-8.png') }}" alt=""
                                            class="rounded-full size-9">
                                    </div>
                                    <div class="grow">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="flex flex-wrap items-center gap-3 mb-5">
                        ...
                        <div class="grow">
                            <h6 class="mb-1 text-15"><a href="#!"
                                    class="transition-all duration-200 ease-linear hover:text-custom-500">Stephen
                                    Tillman</a> -<small class="ml-1 font-normal text-slate-500">25
                                    min</small></h6>
                            <p class="text-slate-500">React Developer at <a href="#!"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul
                        class="inline-flex flex-col gap-3 p-4 mt-4 rounded-md w-80 bg-slate-100 max-w-7xl">
                        <li>
                            <a href="#!" class="relative flex gap-4 group active">
                                ...
                                <div class="grow">
                                    <h6 href="#!">React Js</h6>
                                    <div class="w-full h-1.5 rounded-full bg-white mt-2">
                ...
                <div class="card-body">
                    <div class="flex items-center gap-3">
                        <h6 class="mb-0 grow text-15">Message <span
                                class="inline-flex items-center justify-center size-6 text-xs font-medium border rounded rtl:mr-1 ltr:ml-1 bg-custom-100 border-custom-100 text-custom-500">15</span>
                        </h6>
                        <div class="shrink-0">
                        ...
                        <ul class="flex flex-col gap-3 mt-5 list">
                            <li>
                                <a href="#!"
                                    ...
                                    <div class="relative rounded-full size-7 bg-slate-100">
                                        <img src="{{ URL::asset('build/images/users/avatar-3.png') }}" alt=""
                                            class="rounded-full h-7">
                                        <span
                                            class="bottom-0 ltr:right-0 rtl:left-0 absolute w-2.5 h-2.5 bg-green-400 border-2 border-white rounded-full"></span>
                                    </div>
                                    <h6
                                ...
                                <a href="#!"
                                    ...
                                    <div class="relative rounded-full size-7 bg-slate-100">
                                        <img src="{{ URL::asset('build/images/users/avatar-8.png') }}" alt=""
                                            class="rounded-full h-7">
                                        <span
                                            class="bottom-0 ltr:right-0 rtl:left-0 absolute w-2.5 h-2.5 bg-red-400 border-2 border-white rounded-full"></span>
                                    </div>
                                    <h6
                                        class="transition-all duration-150 ease-linear group-hover/items:text-custom-500 user-name">
                                        Lucie Beahan</h6>
                ...
                <div class="card-body">
                    ...
                    <ul class="flex flex-col gap-3 mt-5">
                        <li>
                            <a href="#!"
                                class="flex items-center gap-3 transition-all duration-150 ease-linear group/items">
                                <div class="relative rounded-full size-9 bg-slate-100">
                                    <img src="{{ URL::asset('build/images/users/avatar-3.png') }}" alt=""
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="#!">
                    ...
                    <div class="mb-4">
                        ...
                        <div
                            class="flex items-center justify-center bg-white border border-dashed rounded-md cursor-pointer dropzone border-slate-300 dropzone2">
                            <div class="fallback">
                        ...
                        <ul class="flex flex-wrap mb-0 gap-x-5" id="dropzone-preview2">
                            <li class="mt-5" id="dropzone-preview-list2">
                                ...
                                <div class="border rounded border-slate-200">
                                    <div class="p-2 text-center">
                                        <div>
                                            <div class="p-2 mx-auto rounded-md size-14 bg-slate-100">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="#!">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"
                            class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 flatpickr-input"
