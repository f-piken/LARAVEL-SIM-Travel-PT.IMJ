...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-1 text-gray-800 text-15">Pagination</h6>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-1 text-gray-800 text-15">Search</h6>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-1 text-gray-800 text-15">Sorting</h6>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-1 text-gray-800 text-15">Resizable Columns</h6>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-1 text-gray-800 text-15">Loading State</h6>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-1 text-gray-800 text-15">Fixed Header</h6>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-1 text-gray-800 text-15">Hidden Columns</h6>
    ...
    <div class="card">
        <div class="card-body">
            <h6 class="mb-1 text-gray-800 text-15">Cell formatting</h6>
