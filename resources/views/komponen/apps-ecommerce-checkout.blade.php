...
@section('content')
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-x-5">
        <div class="xl:col-span-12">
            <div
                class="flex gap-1 px-4 py-3 mb-5 text-sm text-green-500 border border-green-200 rounded-md md:items-center bg-green-50">
                    ...
                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-2">
                        <div class="flex items-center gap-3">
                            <input id="deliveryOption1"
                                class="size-4 border rounded-full appearance-none cursor-pointer bg-slate-100 border-slate-200 checked:bg-purple-500 checked:border-purple-500 checked:disabled:bg-purple-400 checked:disabled:border-purple-400 peer"
                                type="radio" name="deliveryChoose" value="express-delivery" checked>
                            <label for="deliveryOption1"
                                class="flex flex-col gap-4 p-5 border rounded-md cursor-pointer md:flex-row border-slate-200 peer-checked:border-purple-500 grow">
                                <span class="shrink-0">
                                ...
                                <span class="grow">
                                    ...
                                    <span class="text-slate-500">Expected delivery: 01 Nov,
                                        Wednesday</span>
                                </span>
                                <span class="shrink-0">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <label for="deliveryOption2"
                                ...
                                <span class="grow">
                                    ...
                                    <span class="text-slate-500">Expected delivery: 06 Nov,
                                        Monday</span>
                                </span>
                                <span class="shrink-0">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <label for="deliveryOption3"
                                ...
                                <span class="grow">
                                    ...
                                    <span class="text-slate-500">Expected delivery: 11 Nov,
                                        Saturday</span>
                                </span>
                                <span class="shrink-0">
        ...
        <div class="xl:col-span-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div
                        class="px-4 py-3 mb-4 text-sm text-red-500 border border-transparent rounded-md bg-red-50">
            ...
            <div class="card">
                <div class="flex flex-col gap-3 md:items-center card-body md:flex-row">
                    <div class="grow">
                        ...
                        <p class="text-slate-500">2 year of additional care</p>
                    </div>
                    <div class="shrink-0">
                        <b>$24.99</b>
                    </div>
            ...
            <div class="card">
                <div class="flex flex-col gap-3 md:items-center card-body md:flex-row">
                    <div class="grow">
                        ...
                        <p class="text-slate-500">The primary goal of eco-warriors is creating</p>
                    </div>
                    <div class="shrink-0">
                        <b>$19.99</b>
                    </div>
