                            ...
                            <li class="group/item tabs active chatTab">
                                <a href="#!" data-tab-toggle data-target="mainChatList"
                                    class="inline-flex items-center justify-center size-12 transition-all duration-200 ease-linear rounded-md mainChatList"><i
                                        ...
                                        class="mx-auto transition-all size-5 duration-200 ease-linear fill-slate-100 text-slate-500 group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 group-[.active]/item:text-custom-500"></i></a>
                            </li>
                        ...
                        <ul class="flex items-center gap-2 my-auto text-center xl:mb-0 xl:mt-auto xl:pt-4 xl:flex-col">
                            ...
                            <li class="hidden md:block">
                                <div class="relative dropdown">
                                    <a href="#!" type="button"
                                        class="inline-flex items-center justify-center size-12 transition-all duration-200 ease-linear bg-pink-100 rounded-md group/item dropdown-toggle"
                    ...
                    <div class="flex flex-col h-full">
                        <div class="tab-content">
                            <div class="block tab-pane" id="mainChatList">
                                <div class="card-body">
                                    <div class="flex items-center gap-3">
                                        <button
                                            class="inline-flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md shrink-0 bg-slate-100 text-slate-500 hover:text-custom-500"><i
                                ...
                                <div data-simplebar class="max-h-[calc(100vh_-_380px)] xl:max-h-[calc(100vh_-_300px)]">
                                    <ul class="flex flex-col gap-1" id="chatList">
                                        <li class="px-5">
                                            <p class="mb-1 text-slate-500">Recent Chats</p>
                                        </li>
                                        <li>
                                            <a href="#!"
                                                class="flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item active online">
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 size-9 bg-slate-100">
                                                    <img src="{{ URL::asset('build/images/users/avatar-5.png') }}"
                                                        alt="" class="rounded-full h-9">
                                                    <span
                                                        class="absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 bg-red-500"></span>
                                                </div>
                                                <div class="overflow-hidden grow">
                                                    <h6 class="mb-1">Marie Prohaska</h6>
                                                    <p class="text-xs truncate text-slate-500">I will
                                                        purchase it for support</p>
                                                </div>
                                                <div class="self-start shrink-0 text-slate-500">
                                        ...
                                        <li>
                                            <a href="#!"
                                                class="flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item">
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 size-9 bg-slate-100">
                                                ...
                                                <div class="overflow-hidden grow">
                                                    ...
                                                    <p class="text-xs truncate text-slate-500">Hey,
                                                        how's it going?</p>
                                                </div>
                                                <div class="self-start shrink-0 text-slate-500">
                                        ...
                                        <li>
                                            <a href="#!"
                                                class="flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item online">
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 size-9 bg-slate-100">
                                                    <img src="{{ URL::asset('build/images/users/avatar-5.png') }}"
                                                        alt="" class="rounded-full h-9">
                                        ...
                                        <li class="px-5">
                                            <p class="mb-1 text-slate-500">All Conversion</p>
                                        </li>
                                        <li>
                                            <a href="#!"
                                                class="flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item offline">
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 size-9 bg-slate-100">
                                                ...
                                                <div class="overflow-hidden grow">
                                                    ...
                                                    <p class="text-xs truncate text-slate-500">React
                                                        Developer</p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden grow">
                                                    <h6 class="mb-1">Mark Walton</h6>
                                                    <p class="text-xs truncate text-slate-500">UI / UX
                                                        Designer</p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden grow">
                                                    ...
                                                    <p class="text-xs truncate text-slate-500">ASP.Net
                                                        Developer</p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden grow">
                                                    ...
                                                    <p class="text-xs truncate text-slate-500">Angular
                                                        Developer</p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden grow">
                                                    ...
                                                    <p class="text-xs truncate text-slate-500">Laravel
                                                        Developer</p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden grow">
                                                    ...
                                                    <p class="text-xs truncate text-slate-500">Web
                                                        Designer</p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div class="overflow-hidden grow">
                                                    ...
                                                    <p class="text-xs truncate text-slate-500">Project
                                                        Manager</p>
                                                </div>
                                            </a>
                                        </li>
                            ...
                            <div class="hidden tab-pane" id="contactList">
                                ...
                                <div data-simplebar class="max-h-[calc(100vh_-_390px)] xl:max-h-[calc(100vh_-_300px)]">
                                    <ul class="flex flex-col gap-1">
                                        <li class="px-5">
                                            <p class="mb-1 text-slate-500">Contact List</p>
                                        </li>
                                        <li>
                                            <div
                                                class="flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item offline">
                                        ...
                                        <li>
                                            <div
                                                ...
                                                <a href="#!" class="overflow-hidden grow">
                                                    ...
                                                    <p class="text-xs truncate text-slate-500">NodeJS
                                                        Developer</p>
                                                </a>
                                                <div class="relative dropdown shrink-0">
                                                    <button type="button" class="dropdown-toggle"
                                        ...
                                        <li>
                                            <div
                                                ...
                                                <a href="#!" class="overflow-hidden grow">
                                                    ...
                                                    <p class="text-xs truncate text-slate-500">Team
                                                        Leader</p>
                                                </a>
                                                <div class="relative dropdown shrink-0">
                                                    <button type="button" class="dropdown-toggle"
                            ...
                            <div class="hidden tab-pane" id="botChat">
                                ...
                                <p class="mx-5 mb-2 text-slate-500">Recent Find</p>
                                <div data-simplebar class="max-h-[calc(100vh_-_410px)] xl:max-h-[calc(100vh_-_330px)]">
                                    <ul class="flex flex-col gap-1">
                                        <li>
                                            <a href="#!"
                                                class="flex items-center gap-3 px-5 py-2.5 [&.active]:bg-slate-50 active">
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 size-7 shrink-0">
                                        ...
                                        <li>
                                            <a href="#!"
                                                class="flex items-center gap-3 px-5 py-2.5 [&.active]:bg-slate-50">
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 size-7 shrink-0">
                                                    <i data-lucide="messages-square" class="size-4"></i>
                                                </div>
                            ...
                            <div class="hidden tab-pane" id="profile">
                                <div data-simplebar class="max-h-[calc(100vh_-_250px)] xl:max-h-full card-body">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <button
                                            class="inline-flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md shrink-0 bg-slate-100 text-slate-500 hover:text-red-500"><i
                                                data-lucide="x" class="size-4 mx-auto "></i></button>
                                    </div>
                                    <div class="text-center">
                                        <div class="size-20 mx-auto mt-8 bg-pink-100 rounded-full">
                                            <img src="{{ URL::asset('build/images/users/avatar-1.png') }}" alt=""
                                                class="h-20 rounded-full">
                                        </div>
                                        <h5 class="mt-4 text-16">William Heineman</h5>
                                        <p class="text-slate-500">NextJs Developer</p>
                                    </div>
                                    <div class="mt-5">
                                        <p class="mb-3 text-slate-500">Object</p>
                                    ...
                                    <div class="mt-5">
                                        <p class="mb-4 text-slate-500">Personal Information</p>
                                        <h6 class="mb-3 font-medium"><i data-lucide="phone"
                                                class="inline-block size-4 mr-1 text-slate-500"></i>
                                    ...
                                    <div class="mt-5">
                                        <div class="flex items-center gap-2 mb-4">
                                            <p class="text-slate-500 grow">Settings</p>
                                            <a href="#!"
                                                class="text-sm underline text-slate-500 shrink-0">View
                                                More</a>
                                        </div>
                            ...
                            <div class="hidden tab-pane" id="fileDocument">
                                ...
                                <div data-simplebar class="max-h-[calc(100vh_-_380px)] xl:max-h-[calc(100vh_-_300px)]">
                                    <div class="flex flex-col gap-3">
                                        <a href="#!"
                                            class="flex items-center gap-3 !py-3 border-y border-dashed rounded-md card-body border-slate-200">
                                            <div
                                                class="flex items-center justify-center text-sm font-semibold rounded-md size-9 bg-slate-100 text-slate-500 shrink-0">
                                                <img src="{{ URL::asset('build/images/small/img-2.jpg') }}"
                                                    alt="" class="object-cover rounded-md h-9">
                                            </div>
                                            <div class="grow">
                                                <h6>Preview-01.jpg</h6>
                                                <p class="text-slate-500">1.2 MB</p>
                                            </div>
                                        </a>
                                        <a href="#!"
                                            class="flex items-center gap-3 !py-3 border-y border-dashed rounded-md card-body border-slate-200">
                                            ...
                                            <div class="grow">
                                                <h6>changelog.txt</h6>
                                                <p class="text-slate-500">140.62 KB</p>
                                            </div>
                                        </a>
                                        <a href="#!"
                                            class="flex items-center gap-3 !py-3 border-y border-dashed rounded-md card-body border-slate-200">
                                            ...
                                            <div class="grow">
                                                ...
                                                <p class="text-slate-500">97.59 MB</p>
                                            </div>
                                        </a>
                                        <a href="#!"
                                            class="flex items-center gap-3 !py-3 border-y border-dashed rounded-md card-body border-slate-200">
                                            ...
                                            <div class="grow">
                                                ...
                                                <p class="text-slate-500">0.123 KB</p>
                                            </div>
                                        </a>
                                        <a href="#!"
                                            class="flex items-center gap-3 !py-3 border-y border-dashed rounded-md card-body border-slate-200">
                                            ...
                                            <div class="grow">
                                                <h6>pattern.svg</h6>
                                                <p class="text-slate-500">0.802 MB</p>
                                            </div>
                                        </a>
                                        <a href="#!"
                                            class="flex items-center gap-3 !py-3 border-y border-dashed rounded-md card-body border-slate-200">
                                            ...
                                            <div class="grow">
                                                ...
                                                <p class="text-slate-500">33.49 MB</p>
                                            </div>
                                        </a>
                                        <a href="#!"
                                            class="flex items-center gap-3 !py-3 border-y border-dashed rounded-md card-body border-slate-200">
                                        ...
                                        <a href="#!"
                                            ...
                                            <div class="grow">
                                                <h6>tailwick.zip</h6>
                                                <p class="text-slate-500">35.89 MB</p>
                                            </div>
                                        </a>
                                        <a href="#!"
                                            class="flex items-center gap-3 !py-3 border-y border-dashed rounded-md card-body border-slate-200">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="#!" data-drawer-target="drawerEnd"
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500">NextJS Developer</p>
                                </div>
                            </a>
                                ...
                                <li>
                                    <a data-modal-target="callModal" href="#!"
                                        class="inline-flex items-center justify-center size-10 transition-all duration-200 ease-linear rounded-md group/item"><i
                                            data-lucide="phone"
                                            class="mx-auto transition-all size-4 duration-200 ease-linear fill-slate-100 text-slate-500 group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 group-[.active]/item:text-custom-500"></i></a>
                                </li>
                                <li>
                                    <a href="#!"
                                        class="inline-flex items-center justify-center size-10 transition-all duration-200 ease-linear rounded-md group/item"><i
                                ...
                                <li class="hidden md:block">
                                    <a href="#!" data-drawer-target="drawerEnd"
                                        ...
                                        <i data-lucide="panel-right-open"
                                            class="size-4 mx-auto transition-all duration-200 ease-linear fill-slate-100 text-slate-500 group-hover/item:text-custom-500 group-hover/item:fill-custom-100 group-[.active]/item:hidden block"></i>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="relative bg-slate-50 grow">
                        <div class="absolute inset-x-0 top-0 z-10 hidden transition-all duration-200 ease-linear bg-white border-y border-slate-200"
                            id="searchChat">
                            ...
                            <ul class="flex flex-col gap-5 list-none card-body">
                                <li class="flex chat-message group/item [&.right]:justify-end">
                                    <div class="flex gap-3">
                                        <a href="#!"
                                            class="flex items-center self-end justify-center text-sm font-semibold rounded-full size-9 bg-slate-100 text-slate-500 shrink-0 group-[.right]/item:order-3">
                                            <img src="{{ URL::asset('build/images/users/avatar-7.png') }}" alt=""
                                        ...
                                        <div class="grow group-[.right]/item:order-2 flex flex-col gap-3">
                                            <div class="flex gap-3">
                                                <div
                                                    class="relative p-4 bg-white rounded-md ltr:rounded-bl-none rtl:rounded-br-none shadow-sm 2xl:max-w-sm ltr:group-[.right]/item:rounded-br-none rtl:group-[.right]/item:rounded-bl-none ltr:group-[.right]/item:rounded-bl-md rtl:group-[.right]/item:rounded-br-md group-[.right]/item:order-2">
                    ...
                    <div class="card-body">
                        <div class="flex items-center gap-2">
                            ...
                            <div class="flex gap-2 shrink-0">
                                <button type="button"
                                    class="flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 text-slate-500 btn bg-transparent border-transparent hover:text-slate-700 focus:text-slate-700 active:text-slate-700"><i
            ...
            <div
                ...
                <div class="relative">
                    <div data-simplebar class="h-[calc(100vh_-_320px)] xl:h-[calc(100vh_-_250px)]">
                        <div
                            class="sticky top-0 flex items-center gap-3 shadow-sm bg-white/60 backdrop-blur-sm card-body">
                            <div
                        ...
                        <div class="flex gap-3 card-body bg-slate-50">
                            <div
                                class="flex items-center justify-center size-8 font-semibold rounded-full text-slate-500 bg-slate-100 shrink-0">
...
@import 'tailwindcss/utilities';</code></pre>
        ...
        <div id="drawerEnd" drawer-end
            class="fixed inset-y-0 flex flex-col w-full transition-transform duration-300 ease-in-out transform bg-white shadow ltr:right-0 rtl:left-0 md:w-80 z-drawer show">
            <div class="h-full p-4 overflow-y-auto">
                <div>
                    ...
                    <div class="text-center">
                        <div class="size-20 mx-auto mt-8 rounded-full bg-slate-100">
                            <img src="{{ URL::asset('build/images/users/avatar-7.png') }}" alt=""
                                class="h-20 rounded-full">
                        </div>
                        <h5 class="mt-4 text-16">William Heineman</h5>
                    ...
                    <div class="mt-5">
                        <p class="mb-4 text-slate-500">Personal Information</p>
                        <h6 class="mb-3 font-medium"><i data-lucide="phone"
                                class="inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500"></i>
                            <span class="align-middle">+(103) 1234 567 8954</span>
                        </h6>
                        <h6 class="mb-3 font-medium"><i data-lucide="map-pin"
                                class="inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500"></i>
                    ...
                    <div class="mt-5">
                        <div class="flex items-center gap-2 mb-4">
                            <p class="text-slate-500 grow">Settings</p>
                            <a href="#!" class="text-sm underline text-slate-500 shrink-0">View
                                More</a>
                        </div>
                        <div class="flex items-center mb-3">
                            <div
                    ...
                    <div class="mt-5">
                        <p class="mb-4 text-slate-500">Recent Shares</p>

                        <div>
                            <div class="flex flex-col gap-3">
                                <a href="#!"
                                    class="flex items-center gap-3 p-2 border border-dashed rounded-md border-slate-200">
                                    <div
                                        class="flex items-center justify-center text-sm font-semibold rounded-md size-9 bg-slate-100 text-slate-500 shrink-0">
        ...
        <div id="addContactModal" modal-center
            ...
            <div class="w-screen md:w-[30rem] bg-white shadow rounded-md flex flex-col h-full">
                ...
                <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                    <form action="#!">
                        <div
                            class="relative size-24 mx-auto mb-4 rounded-full shadow-md bg-slate-100 profile-user">
                            ...
                            <div
                                ...
                                <label for="profile-img-file-input"
                                    ...
                                    <i data-lucide="image-plus"
                                        class="size-4 text-slate-500 fill-slate-200"></i>
                                </label>
                            </div>
                        </div>
                        <div class="mb-3">
