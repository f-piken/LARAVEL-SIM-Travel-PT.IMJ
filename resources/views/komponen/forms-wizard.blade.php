                    ...
                    <ul class="grid grid-cols-1 gap-3 lg:grid-cols-4 nav-tabs form-wizard">
                        <li class="group/item active">
                            <a href="#!" data-target="accountInfo" data-tab-id="1"
                                class="block px-4 py-5 text-center rounded-md text-slate-500 bg-slate-50 group-[.active]/item:bg-custom-500 group-[.active]/item:text-custom-50">
                                <i data-lucide="rocket"
                                    class="block h-6 mx-auto fill-slate-200 group-[.active]/item:fill-slate-200"></i>
                                ...
                                <div class="grid grid-cols-1 gap-3 mb-4 md:grid-cols-3 lg:grid-cols-4">
                                    <div>
                                        <input id="brandingRadio" name="businessType"
                                            class="hidden size-4 border rounded-full appearance-none peer/business bg-slate-100 border-slate-200 checked:bg-custom-500 checked:border-custom-500"
                                            type="radio" value="" checked>
                                        <label for="brandingRadio"
                                            class="block px-3 text-center border rounded-md cursor-pointer border-slate-200 py-7 text-slate-500 peer-checked/business:border-custom-500 peer-checked/business:text-custom-500">
                                            <i data-lucide="gem"
                                                class="block size-8 mx-auto mb-3 stroke-1 fill-slate-100"></i>
                        ...
                        <div class="hidden tab-pane" data-tab-id="2" id="personalInfo">
                            ...
                            <form action="#!">
                                ...
                                <!-- <div class="flex justify-between gap-2 mt-5">
                                                    ...
                                                    <button type="button" data-action="next" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100"><span class="align-middle">Next</span> <i data-lucide="move-right" class="inline-block h-4 ml-1"></i></button>
                                                </div> -->
                            </form>
                        </div>
                        ...
                        <div class="hidden tab-pane" data-tab-id="4" id="completed">
                            <div class="px-4 py-6 mx-auto text-center lg:w-2/3">
                                <i data-lucide="check-circle"
                                    class="block size-10 mx-auto mb-4 text-green-500 fill-green-100 animate-icons"></i>
