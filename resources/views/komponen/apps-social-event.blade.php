...
@section('content')
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-x-5">
        ...
        <div class="xl:col-span-9" id="eventList">
            ...
            <div
                class="px-4 py-3 mb-4 text-sm text-green-500 border border-green-200 rounded-md bg-green-50">
                <span class="font-bold">Join us for the upcoming event:</span> Community Clean-Up Day on October 15, 2023
                <a href="#!"
                    class="px-2.5 py-0.5 text-xs font-medium inline-block rounded border transition-all duration-200 ease-linear bg-green-100 border-transparent text-green-500 hover:bg-green-200 ltr:ml-1 rtl:mr-1">Register
                    Now</a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full border-separate table-custom border-spacing-y-2 whitespace-nowrap">
                    <thead class="ltr:text-left rtl:text-right">
                        <tr
                            class="relative bg-white rounded-md after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent">
                    ...
                    <tbody class="list">
                        <tr
                            ...
                            <td class="px-3.5 py-2.5"><span
                                    class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-green-100 border-green-200 text-green-500 status">Ongoing</span>
                            </td>
                        ...
                        <tr
                            ...
                            <td class="px-3.5 py-2.5"><span
                                    class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-custom-100 border-custom-200 text-custom-500 status">Draft</span>
                            </td>
                            <td class="px-3.5 py-2.5">
                                <div class="relative dropdown">
                                    <button
                        ...
                        <tr
                            ...
                            <td class="px-3.5 py-2.5"><span
                                    class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-red-100 border-red-200 text-red-500 status">Closed</span>
                            </td>
                            <td class="px-3.5 py-2.5">
                                <div class="relative dropdown">
                                    <button
                ...
                <div class="mt-5 text-center">
                    ...
                    <div class="flex justify-center gap-2 mt-6">
                        <button type="reset" data-modal-close="deleteModal"
                            class="transition-all duration-200 ease-linear bg-white border-white text-slate-500 btn hover:text-slate-600 focus:text-slate-600 active:text-slate-600">Cancel</button>
                        <button type="submit"
