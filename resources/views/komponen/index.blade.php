    ...
    <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                ...
                <div class="grid grid-cols-12 gap-4 mb-3">
                    <div class="col-span-12 md:col-span-6 lg:col-span-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="grow">
                                <p class="mb-1 text-slate-500">Total Sales</p>
            ...
            <div class="card-body">
                ...
                <div class="flex flex-col items-center mt-5 md:flex-row">
                    <div class="mb-4 grow md:mb-0">
                        <p class="text-slate-500">Showing <b>07</b> of <b>19</b> Results</p>
                    </div>
        ...
        <div class="col-span-12 card lg:col-span-6 2xl:col-span-3">
            <div class="card-body">
                ...
                <div>
                    <div class="flex items-center justify-between mt-5 mb-2">
                        <p class="text-slate-500">28% of the Goal Reached ($25k)</p>
                    </div>
                    ...
                    <div class="grid mt-3 xl:grid-cols-2">
                        <div class="flex items-center gap-2">
                            <div class="shrink-0">
                                <i data-lucide="calendar-days" class="inline-block size-4 mb-1 align-middle"></i>
                            </div>
                            <p class="mb-0 text-slate-500">This Month: <span
                                    class="font-medium text-slate-800">$13,741</span></p>
                        </div>
                    </div>
                </div>
                ...
                <ul class="divide-y divide-slate-200">
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="size-8 rounded-full shrink-0 bg-slate-100">
                            <img src="{{ URL::asset('build/images/users/avatar-2.png') }}" alt="" class="size-8 rounded-full">
                        </div>
                        <div class="grow">
                            <h6 class="font-medium">Urrie Arthur</h6>
                            <p class="text-slate-500">arthur@tailwick.com</p>
                        </div>
                        <div class="shrink-0">
                            <h6>$2,452</h6>
                        </div>
                    ...
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="size-8 rounded-full shrink-0 bg-slate-100">
                            <img src="{{ URL::asset('build/images/users/avatar-3.png') }}" alt="" class="size-8 rounded-full">
                        </div>
                        <div class="grow">
                            <h6 class="font-medium">Natalie Christy</h6>
                            <p class="text-slate-500">natalie@tailwick.com</p>
                        </div>
                        <div class="shrink-0">
                            <h6>$1,893</h6>
                        </div>
                    ...
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="size-8 rounded-full shrink-0 bg-slate-100">
                            <img src="{{ URL::asset('build/images/users/avatar-4.png') }}" alt="" class="size-8 rounded-full">
                        </div>
                        <div class="grow">
                            <h6 class="font-medium">Laurie Jackson</h6>
                            <p class="text-slate-500">jackson@tailwick.com</p>
                        </div>
                        <div class="shrink-0">
                            <h6>$1,196</h6>
                        </div>
                    ...
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="size-8 rounded-full shrink-0 bg-slate-100">
                            <img src="{{ URL::asset('build/images/users/avatar-5.png') }}" alt="" class="size-8 rounded-full">
                        </div>
                        <div class="grow">
                            <h6 class="font-medium">Michael Torres</h6>
                            <p class="text-slate-500">torres@tailwick.com</p>
                        </div>
                        <div class="shrink-0">
                            <h6>$976</h6>
                        </div>
            ...
            <div class="card-body">
                ...
                <ul class="flex flex-col gap-5">
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center size-10 rounded-md bg-slate-100">
                        ...
                        <h6 class="shrink-0"><i data-lucide="shopping-cart"
                                class="inline-block size-4 align-middle text-slate-500 ltr:mr-1 rtl:ml-1"></i>
                            798</h6>
                    </li>
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center size-10 rounded-md bg-slate-100">
