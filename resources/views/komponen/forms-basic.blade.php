            ...
            <div class="card-body">
                <div>
                    ...
                    <input type="text" id="inputPlainReadOnly"
                        class="border-transparent form-input focus:outline-none focus:border-transparent disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
        ...
        <div class="card">
            <div class="card-body">
                <div>
                    ...
                    <div class="relative">
                        <i data-lucide="mail"
                            class="absolute size-4 ltr:right-3 rtl:left-3 top-3 text-slate-500"></i>
                        <input type="email" id="inputIconRight"
                            class="ltr:pr-10 rtl:pl-10 form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
                            placeholder="Enter your email">
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div>
                    ...
                    <input type="text" id="inputBorderStyle"
                        class="border-dashed form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
            ...
            <div class="card-body">
                <div>
                    ...
                    <input type="text" id="inputRoundedInput"
                        class="rounded-full form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
            ...
            <div class="card-body">
                <div>
                    ...
                    <input type="email" id="inputValid"
                        class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 valid:border-green-500 invalid:border-red-500"
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="grid items-center grid-cols-1 gap-5 xl:grid-cols-3">
                <div>
                    <input type="text"
                        class="px-3 py-1 text-xs form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
                        placeholder="Enter your name">
                </div>
                <div>
                    <input type="text"
                ...
                <div>
                    <input type="text"
                        class="px-5 py-3 text-15 form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
                        placeholder="Enter your name">
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="grid items-center grid-cols-1 gap-5 xl:grid-cols-3">
                <div>
                    <input type="file"
                        class="cursor-pointer form-file form-file-sm border-slate-200 focus:outline-none focus:border-custom-500"
                        placeholder="Enter your name">
                </div>
                <div>
                    <input type="file"
                        class="cursor-pointer form-file border-slate-200 focus:outline-none focus:border-custom-500"
                        placeholder="Enter your name">
                </div>
                <div>
                    <input type="file"
                        class="cursor-pointer form-file form-file-lg border-slate-200 focus:outline-none focus:border-custom-500"
                        placeholder="Enter your name">
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="grid items-center grid-cols-1 gap-5 xl:grid-cols-3">
                <div class="flex items-center">
                    <span
                        class="inline-block px-3 py-2 border ltr:border-r-0 rtl:border-l-0 border-slate-200 bg-slate-100 ltr:rounded-l-md rtl:rounded-r-md">@</span>
                    <input type="text" id="inputText"
                        class="ltr:rounded-l-none rtl:rounded-r-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
                        placeholder="@name">
                </div>
                <div class="flex items-center">
                    <span
                        class="inline-block px-3 py-2 border ltr:border-r-0 rtl:border-l-0 border-slate-200 ltr:rounded-l-md rtl:rounded-r-md">$</span>
                ...
                <div class="flex items-center">
                    <input type="text" id="inputText"
                        ...
                        placeholder="@name">
                    <span
                        class="inline-block px-3 py-2 border border-l-0 border-slate-200 bg-slate-100 ltr:rounded-r-md rtl:rounded-l-md">@</span>
                </div>
            </div>
        </div>
    </div><!--end card-->
