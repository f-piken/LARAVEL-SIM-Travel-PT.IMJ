...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-2">
        <div class="card">
            <div class="card-body">
                <h6 class="mb-4 text-gray-800 text-15">Simple</h6>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-4 text-gray-800 text-15">Candlestick Synced with Brush Chart (Combo)</h6>
                <div>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-4 text-gray-800 text-15">Category x-axis</h6>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-4 text-gray-800 text-15">Candlestick with Line</h6>
