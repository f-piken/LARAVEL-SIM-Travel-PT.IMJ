        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="flex flex-wrap gap-2 toolbar align-items-start justify-content-center">
                    <button type="button"
                        class="px-2 py-1.5 text-xs text-custom-500 btn bg-custom-100 hover:text-white hover:bg-custom-600 focus:text-white focus:bg-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:ring active:ring-custom-100 [&.active]:bg-custom-500 [&.active]:text-white"
                        id="one_month">
                        1M
                    </button>
                    <button type="button"
                    ...
                    <button type="button"
                        class="px-2 py-1.5 text-xs text-custom-500 btn bg-custom-100 hover:text-white hover:bg-custom-600 focus:text-white focus:bg-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:ring active:ring-custom-100 active [&.active]:bg-custom-500 [&.active]:text-white"
                        id="one_year">
                        1Y
                    </button>
                    <button type="button"
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="flex items-center my-3 github-style">
                        ...
                        <div class="grow">
                            <a class="font-medium text-15 text-slate-800">Themesdesign</a>
                            <div class="text-sm cmeta text-slate-500">
                                <span class="font-medium commits text-slate-800"></span> commits
                            </div>
                        </div>
                    </div>
