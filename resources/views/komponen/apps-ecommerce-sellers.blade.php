        ...
        <div class="2xl:col-span-3">
            <div class="card">
                <div class="card-body">
                    <div class="flex items-center gap-2 mb-4">
                        <div class="grow">
                            <a href="#!" class="group/item toggle-button"><i data-lucide="heart"
                                    class="size-5 text-slate-500 fill-slate-200 transition-all duration-150 ease-linear group-[.active]/item:text-yellow-500 group-[.active]/item:fill-yellow-200 group-hover/item:text-yellow-500 group-hover/item:fill-yellow-200"></i></a>
                        </div>
                    ...
                    <div
                        class="flex items-center justify-center size-16 mx-auto rounded-full bg-slate-100 outline outline-slate-100 outline-offset-1">
                    ...
                    <div class="mt-4 mb-6 text-center">
                        ...
                        <p class="text-slate-500">Paula Keenan</p>
                    </div>
                    <div
                        class="grid grid-cols-1 gap-5 text-center divide-y md:divide-y-0 md:divide-x sm:grid-cols-3 2xl:grid-cols-12 divide-slate-200 divide-dashed rtl:divide-x-reverse">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4 mb-6 text-center">
                        ...
                        <p class="text-slate-500">Kara Miller</p>
                    </div>
                    <div
                        class="grid grid-cols-1 gap-5 text-center divide-y md:divide-y-0 md:divide-x sm:grid-cols-3 2xl:grid-cols-12 divide-slate-200 divide-dashed rtl:divide-x-reverse">
                        <div class="p-2 2xl:col-span-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4 mb-6 text-center">
                        ...
                        <p class="text-slate-500">Daniel Miller</p>
                    </div>
                    <div
                        class="grid grid-cols-1 gap-5 text-center divide-y md:divide-y-0 md:divide-x sm:grid-cols-3 2xl:grid-cols-12 divide-slate-200 divide-dashed rtl:divide-x-reverse">
                        <div class="p-2 2xl:col-span-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4 mb-6 text-center">
                        ...
                        <p class="text-slate-500">Mark Walton</p>
                    </div>
                    <div
                        class="grid grid-cols-1 gap-5 text-center divide-y md:divide-y-0 md:divide-x sm:grid-cols-3 2xl:grid-cols-12 divide-slate-200 divide-dashed rtl:divide-x-reverse">
                        <div class="p-2 2xl:col-span-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4 mb-6 text-center">
                        ...
                        <p class="text-slate-500">William Heineman</p>
                    </div>
                    <div
                        class="grid grid-cols-1 gap-5 text-center divide-y md:divide-y-0 md:divide-x sm:grid-cols-3 2xl:grid-cols-12 divide-slate-200 divide-dashed rtl:divide-x-reverse">
                        <div class="p-2 2xl:col-span-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4 mb-6 text-center">
                        ...
                        <p class="text-slate-500">David Biggs</p>
                    </div>
                    <div
                        class="grid grid-cols-1 gap-5 text-center divide-y md:divide-y-0 md:divide-x sm:grid-cols-3 2xl:grid-cols-12 divide-slate-200 divide-dashed rtl:divide-x-reverse">
                        <div class="p-2 2xl:col-span-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4 mb-6 text-center">
                        ...
                        <p class="text-slate-500">Jaqueline Hammes</p>
                    </div>
                    <div
                        class="grid grid-cols-1 gap-5 text-center divide-y md:divide-y-0 md:divide-x sm:grid-cols-3 2xl:grid-cols-12 divide-slate-200 divide-dashed rtl:divide-x-reverse">
                        <div class="p-2 2xl:col-span-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4 mb-6 text-center">
                        ...
                        <p class="text-slate-500">Ashley Uilson</p>
                    </div>
                    <div
                        class="grid grid-cols-1 gap-5 text-center divide-y md:divide-y-0 md:divide-x sm:grid-cols-3 2xl:grid-cols-12 divide-slate-200 divide-dashed rtl:divide-x-reverse">
                        <div class="p-2 2xl:col-span-4">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="#!">
                    <div class="mb-3">
                        ...
                        <div
                            class="flex items-center justify-center bg-white border border-dashed rounded-md cursor-pointer dropzone border-slate-200 dropzone2">
                            <div class="fallback">
