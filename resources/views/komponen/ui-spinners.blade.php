...
@section('content')
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <div
                        class="inline-block size-8 border-2 rounded-full animate-spin border-l-transparent border-slate-400">
                    </div>
                    <div
                        class="inline-block size-8 border-2 rounded-full animate-spin border-l-transparent border-slate-900">
                    </div>
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="flex flex-wrap items-center gap-5 px-3 py-2">
                    ...
                    <div class="inline-flex size-4 rounded-full opacity-75 animate-ping bg-slate-900">
                    </div>
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="mb-4 text-gray-800 text-15">Bounce Animation</h5>
            <div class="flex flex-wrap items-center gap-5">
                ...
                <div class="inline-flex size-6 rounded-full opacity-75 animate-bounce bg-slate-900"></div>
            </div>
        </div><!-- end card-body -->
    </div><!-- end card -->
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="mb-4 text-gray-800 text-15">Sizes Animation</h5>
