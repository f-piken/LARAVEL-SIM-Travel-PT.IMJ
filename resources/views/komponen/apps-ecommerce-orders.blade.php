    ...
    <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 2xl:grid-cols-12">
        <div class="2xl:col-span-2 2xl:row-span-1">
            <div class="card">
                <div class="flex items-center gap-3 card-body">
                    <div
                        class="flex items-center justify-center size-12 rounded-md text-15 bg-custom-50 text-custom-500 shrink-0">
        ...
        <div class="2xl:col-span-2 2xl:row-span-1">
            <div class="card">
                <div class="flex items-center gap-3 card-body">
                    <div
                        class="flex items-center justify-center size-12 rounded-md text-15 bg-sky-50 text-sky-500 shrink-0">
                        <i data-lucide="package-plus"></i>
                    </div>
                    <div class="grow">
                        <h5 class="mb-1 text-16 counter-value" data-target="3874"></h5>
                        <p class="text-slate-500">New Orders</p>
                    </div>
                </div>
            </div>
        </div><!--end col-->
        <div class="order-last md:col-span-2 2xl:col-span-8 2xl:row-span-3 card 2xl:order-none">
            <div class="card-body">
                <h6 class="mb-4 text-gray-800 text-15">Orders Overview</h6>
        ...
        <div class="2xl:col-span-2 2xl:row-span-1">
            <div class="card">
                <div class="flex items-center gap-3 card-body">
                    <div
                        class="flex items-center justify-center size-12 text-yellow-500 rounded-md text-15 bg-yellow-50 shrink-0">
                        <i data-lucide="loader"></i>
                    </div>
                    <div class="grow">
                        <h5 class="mb-1 text-16 counter-value" data-target="1548">0</h5>
                        <p class="text-slate-500">Pending Orders</p>
                    </div>
                </div>
            </div>
        </div><!--end col-->
        <div class="2xl:col-span-2 2xl:row-span-1">
            <div class="card">
                <div class="flex items-center gap-3 card-body">
                    <div
                        class="flex items-center justify-center size-12 text-purple-500 rounded-md text-15 bg-purple-50 shrink-0">
                        <i data-lucide="truck"></i>
                    </div>
                    <div class="grow">
                        <h5 class="mb-1 text-16 counter-value" data-target="9543">0</h5>
                        <p class="text-slate-500">Shipping Orders</p>
                    </div>
                </div>
            </div>
        </div><!--end col-->
        <div class="2xl:col-span-2 2xl:row-span-1">
            <div class="card">
                <div class="flex items-center gap-3 card-body">
                    <div
                        class="flex items-center justify-center size-12 text-green-500 rounded-md text-15 bg-green-50 shrink-0">
                        <i data-lucide="package-check"></i>
                    </div>
                    <div class="grow">
                        <h5 class="mb-1 text-16 counter-value" data-target="30914">0</h5>
                        <p class="text-slate-500">Delivered Orders</p>
                    </div>
                </div>
            </div>
        </div><!--end col-->
        <div class="2xl:col-span-2 2xl:row-span-1">
            <div class="card">
                <div class="flex items-center gap-3 card-body">
                    <div
                        class="flex items-center justify-center size-12 text-red-500 rounded-md text-15 bg-red-50 shrink-0">
                        <i data-lucide="package-x"></i>
                    </div>
                    <div class="grow">
                        <h5 class="mb-1 text-16 counter-value" data-target="3863">0</h5>
                        <p class="text-slate-500">Cancelled Orders</p>
                    </div>
                </div>
            </div>
        </div><!--end col-->
        ...
        <div class="card-body">
            ...
            <ul class="flex flex-wrap w-full mt-5 text-sm font-medium text-center text-gray-500 nav-tabs">
                <li class="group active">
                    <a href="javascript:void(0);" data-tab-toggle data-target="allOrders"
                        class="inline-block px-4 py-1.5 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]"><i
            ...
            <div class="mt-5 overflow-x-auto">
                <table class="w-full whitespace-nowrap">
                    <thead class="ltr:text-left rtl:text-right bg-slate-100">
                        <tr>
                            <th
                                class="px-3.5 py-2.5 font-semibold text-slate-500 border-b border-slate-200">
                            ...
                            <th class="px-3.5 py-2.5 font-semibold text-slate-500 border-b border-slate-200 sort"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 order_date">08 Jun,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 delivery_date">15 Jun,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">Marie
                                Prohaska</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 payment_method">Credit
                                Card</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 amount">$541.32</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <span
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 order_date">11 July,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 delivery_date">20 July,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">
                                Jaqueline Hammes</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 payment_method">Paypal
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 amount">$1,876.33</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <span
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 order_date">21 Aug,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 delivery_date">24 Aug,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">Marlene
                                Hirthe</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 payment_method">Visa
                                Card</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 amount">$15,023.99</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <span
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 order_date">28 Nov,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 delivery_date">02 Dec,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">Reagan
                                Larson</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 payment_method">
                                American Express</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 amount">$783.56</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <span
                                    class="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-green-100 border-green-200 text-green-500">Delivered</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 order_date">11 Oct,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 delivery_date">16 Oct,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">Glennie
                                Langosh</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 payment_method">
                                American Express</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 amount">$986.49</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <span
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 order_date">16 Feb,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 delivery_date">22 Feb,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">Rickie
                                Cremin</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 payment_method">COD
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 amount">$741.32</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <span
                                    class="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-green-100 border-green-200 text-green-500">Delivered</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 order_date">18 April,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 delivery_date">29
                                April, 2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">Domenic
                                Tromp</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 payment_method">Credit
                                Card</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 amount">$1,386.49</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <span
                                    class="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-purple-100 border-purple-200 text-purple-500">Shipping</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 order_date">21 Jan,
                                2024</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 delivery_date">24 Jan,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">Akeem
                                Paucek</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 payment_method">PayPal
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 amount">$3,487.21</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <span
                                    class="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-sky-100 border-sky-200 text-sky-500">New</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 order_date">05 Oct,
                                2024</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 delivery_date">11 Oct,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">David
                                Gaby</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 payment_method">COD
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 amount">$5,986.11</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <span
                                    class="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-slate-100 border-slate-200 text-slate-500">Return</span>
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <div class="relative dropdown">
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 order_date">07 Oct,
                                2024</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 delivery_date">13 Oct,
                                2023</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 customer_name">Joel
                                Freeleagus</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 payment_method">
                                American Express</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 amount">$9,451.75</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <span
                                    class="delivery_status px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-red-100 border-red-200 text-red-500">Cancelled</span>
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200">
                                <div class="relative dropdown">
                ...
                <div class="noresult" style="display: none">
                    <div class="py-6 text-center">
                        ...
                        <p class="mb-0 text-slate-500">We've searched more than 299+ orders We did not
            ...
            <div class="flex flex-col items-center mt-5 md:flex-row">
                <div class="mb-4 grow md:mb-0">
                    <p class="text-slate-500">Showing <b>10</b> of <b>18</b> Results</p>
                </div>
