...
@section('content')
    ...
    <body class="font-public">
        ...
        <div
            class="relative flex flex-col w-full overflow-hidden xl:flex-row to-custom-800 bg-gradient-to-r from-custom-900">
            ...
            <div
                class="min-h-[calc(100vh_-_theme('spacing.4')_*_2)] mx-3 lg:w-[40rem] shrink-0 px-10 py-14 flex items-center justify-center m-4 bg-white rounded z-10 relative md:mx-auto xl:mx-4">
                    ...
                    <div class="my-auto">
                            ...
                            <ul class="flex flex-wrap w-full gap-2 text-sm font-medium text-center nav-tabs">
                                <li class="group grow active">
                                    <a href="javascript:void(0);" data-tab-toggle data-target="emailLogin"
                                        class="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 bg-slate-100 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]"><i
                        ...
                        <div class="lg:w-[25rem] mx-auto">
                            ...
                            <div
                                ...
                                <h5
                                    class="inline-block px-4 py-0.5 text-sm bg-white text-slate-500 rounded relative">
                            ...
                            <div class="mt-10 text-center">
                                <p class="mb-0 text-slate-500">Already have an account ? <a
                                        href="{{ url('auth-login-basic') }}"
                                        class="font-semibold underline transition-all duration-150 ease-linear text-slate-500 hover:text-custom-500">Login</a>
                                </p>
                            </div>
                    ...
                    <div class="mt-5">
                        <p class="mb-0 text-center text-15 text-slate-500">©
                            ...
                            <a href="http://themesdesign.in"
                                class="underline transition-all duration-200 ease-linear text-slate-800 hover:text-custom-500">Themesdesign</a>
                        </p>
                    </div>
                </div>
            </div>
