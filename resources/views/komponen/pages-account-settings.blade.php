            ...
            <ul class="flex flex-wrap w-full text-sm font-medium text-center nav-tabs">
                ...
                <li class="group">
                    <a href="javascript:void(0);" data-tab-toggle data-target="integrationTabs"
                        class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 -mb-[1px]">Integration</a>
                </li>
                <li class="group">
                ...
                <li class="group">
                    <a href="javascript:void(0);" data-tab-toggle data-target="privacyPolicyTabs"
                        class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 -mb-[1px]">Privacy
                        Policy</a>
                </li>
            </ul>
        </div>
        ...
        <div class="block tab-pane" id="personalTabs">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-4 text-slate-500">Update your photo and personal details here easily.
                    </p>
                    <form action="#!">
                        <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-12">
                                ...
                                <textarea
                                    class="w-full form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
            ...
            <div class="grid grid-cols-1 gap-x-5 sm:grid-cols-2 xl:grid-cols-4">
                <div class="card">
                    <div class="card-body">
                        <div class="flex gap-3 mb-5">
                            ...
                            <div class="shrink-0">
                                <button type="button"
                                    class="px-2 py-1.5 text-xs bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600"><i
                        ...
                        <p class="text-slate-500">Meta Platforms Inc, which used to be called Facebook
                            Inc.</p>
                    </div>
                </div><!--end col-->
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-slate-500">Figma is a cloud-based design tool that is similar to
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-slate-500">Telegram Tools offers multiple useful tools for
                            Telegram users.</p>
                    </div>
                </div><!--end col-->
            </div><!--end grid-->
        ...
        <div class="hidden tab-pane" id="privacyPolicyTabs">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="space-y-6">
                        <div class="flex flex-col justify-between gap-2 md:flex-row">
                            <div>
                                ...
                                <p class="mt-1 text-slate-500">Two-factor authentication is an enhanced
                        ...
                        <div class="flex flex-col justify-between gap-2 md:flex-row">
                            <div>
                                ...
                                <p class="mt-1 text-slate-500">The first factor is a password and the
                        ...
                        <div class="flex flex-col justify-between gap-2 md:flex-row">
                            <div>
                                ...
                                <p class="mt-1 text-slate-500">A backup code is automatically generated
                    ...
                    <div class="space-y-6">
                        <div class="flex justify-between gap-2">
                            <div>
                                ...
                                <p class="mt-1 text-slate-500">Messages from people you follow</p>
                            </div>
                            <div class="shrink-0">
                                <div
                        ...
                        <div class="flex justify-between gap-2">
                            <div>
                                ...
                                <p class="mt-1 text-slate-500">Under Settings, choose Notifications.
                        ...
                        <div class="flex justify-between gap-2">
                            <div>
                                ...
                                <p class="mt-1 text-slate-500">Get real-time purchase alerts to protect
                    ...
                    <p class="mt-1 text-slate-500">Go to the Data & Privacy section of your profile
