...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div class="card">
            <div class="bg-slate-200 card-body rounded-t-md">
                <h6 class="text-15">
                    Card title
                </h6>
            </div>
        ...
        <div class="card">
            ...
            <div class="bg-slate-200 card-body rounded-b-md">
                <p class="text-slate-500 ext-sm">
    ...
    <div class="grid grid-cols-1 gap-5 xl:grid-cols-2">
        ...
        <div class="card sm:flex">
            <div class="flex flex-wrap">
                <div class="flex flex-col h-full card-body">
                    <h6 class="text-gray-800 text-15">
                        Card title
                    </h6>
                    <p class="mt-2 text-slate-500">
                        Some quick example text to build on the card title and make up the bulk of the card's content.
    ...
    <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
        <div class="border card border-custom-200">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Custom Card
                </h6>
        ...
        <div class="border border-green-200 card">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Green Card
                </h6>
        ...
        <div class="border border-orange-200 card">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Orange Card
                </h6>
        ...
        <div class="border card border-sky-200">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Sky Card
                </h6>
        ...
        <div class="border border-yellow-200 card">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Yellow Card
                </h6>
        ...
        <div class="border border-red-200 card">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Red Card
                </h6>
        ...
        <div class="border border-purple-200 card">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Purple Card
                </h6>
    ...
    <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
        <div class="border border-dashed card border-custom-200">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Custom Card
                </h6>
        ...
        <div class="border border-green-200 border-dashed card">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Green Card
                </h6>
        ...
        <div class="border border-orange-200 border-dashed card">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Orange Card
                </h6>
        ...
        <div class="border border-dashed card border-sky-200">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Sky Card
                </h6>
        ...
        <div class="border border-yellow-200 border-dashed card">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Yellow Card
                </h6>
        ...
        <div class="border border-red-200 border-dashed card">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Red Card
                </h6>
        ...
        <div class="border border-purple-200 border-dashed card">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Purple Card
                </h6>
        ...
        <div class="border border-dashed card border-slate-200">
            <div class="card-body">
                <h6 class="mb-4 text-15">
                    Slate Card
                </h6>
    ...
    <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
        <div class="card bg-custom-500 border-custom-500">
            <div class="card-body">
                <h6 class="mb-4 text-white text-15">
                    Custom Card
                </h6>
                <p class="mb-4 text-custom-200">
                    With supporting text below as a natural lead-in to additional content.
                </p>
        ...
        <div class="bg-green-500 border-green-500 card">
            <div class="card-body">
                <h6 class="mb-4 text-white text-15">
                    Card title
                </h6>
        ...
        <div class="bg-yellow-500 border-yellow-500 card">
            <div class="card-body">
                <h6 class="mb-4 text-white text-15">
                    Yellow Card
                </h6>
        ...
        <div class="card bg-sky-500 border-sky-500">
            <div class="card-body">
                <h6 class="mb-4 text-white text-15">
                    Sky Card
                </h6>
                <p class="mb-4 text-sky-200">
                    With supporting text below as a natural lead-in to additional content.
                </p>
        ...
        <div class="bg-red-500 border-red-500 card">
            <div class="card-body">
                <h6 class="mb-4 text-white text-15">
                    Red Card
                </h6>
        ...
        <div class="bg-purple-500 border-purple-500 card">
            <div class="card-body">
                <h6 class="mb-4 text-white text-15">
                    Purple Card
                </h6>
        ...
        <div class="card bg-slate-500 border-slate-500">
            <div class="card-body">
                <h6 class="mb-4 text-white text-15">
                    Slate Card
                </h6>
    ...
    <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
        <div class="card bg-custom-100 border-custom-200">
            <div class="card-body">
                <h6 class="mb-4 text-custom-500 text-15">
                    Custom Card
                </h6>
        ...
        <div class="bg-green-100 border-green-200 card">
            <div class="card-body">
                <h6 class="mb-4 text-green-500 text-15">
                    Green Card
                </h6>
        ...
        <div class="bg-orange-100 border-orange-200 card">
            <div class="card-body">
                <h6 class="mb-4 text-orange-500 text-15">
                    Orange Card
                </h6>
        ...
        <div class="card bg-sky-100 border-sky-200">
            <div class="card-body">
                <h6 class="mb-4 text-sky-500 text-15">
                    Sky Card
                </h6>
        ...
        <div class="bg-yellow-100 border-yellow-200 card">
            <div class="card-body">
                <h6 class="mb-4 text-yellow-500 text-15">
                    Yellow Card
                </h6>
        ...
        <div class="bg-red-100 border-red-200 card">
            <div class="card-body">
                <h6 class="mb-4 text-red-500 text-15">
                    Red
                </h6>
        ...
        <div class="bg-purple-100 border-purple-200 card">
            <div class="card-body">
                <h6 class="mb-4 text-purple-500 text-15">
                    Purple Card
                </h6>
        ...
        <div class="card bg-slate-200 border-slate-200">
            <div class="card-body">
                <h6 class="mb-4 text-slate-400 text-15">
                    Slate Card
                </h6>
    ...
    <div class="grid overflow-hidden border sm:flex card">
        <div
            class="flex flex-col flex-[1_0_0%] rtl:border-b rtl:sm:border-b-0 ltr:border-r rtl:sm:border-l border-slate-200">
            ...
            <div class="border-t card-body border-slate-200">
                <p class="text-xs">
                    Last updated 5 mins ago
                </p>
            </div>
