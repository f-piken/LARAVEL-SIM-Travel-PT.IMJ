    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                ...
                <div>
                    <select
                        class="rounded-full form-select border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400">
                        <option selected>Open this select menu</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="grid items-center grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                <div>
                    <select
                        class="py-1 pl-3 text-xs pr-7 form-select border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400">
                        <option selected>Open this select menu</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
                ...
                <div>
                    <select
                        class="py-3 pl-5 pr-8 form-select border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 text-15">
                        <option selected>Open this select menu</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
    ...
    <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
        <div class="card">
            <div class="card-body">
                ...
                <p class="mb-4 text-slate-500">Set <code
