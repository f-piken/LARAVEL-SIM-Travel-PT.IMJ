    ...
    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
        <div class="card">
            <div class="card-body">
                ...
                <h1 class="mb-4 font-normal"><span class="text-slate-500">$</span>9.99<small
                        class="text-15 text-slate-500">/Monthly</small></h1>
                <button type="button"
                    class="w-full bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600">Purchase
                    Now</button>
                <ul class="flex flex-col gap-3 mt-5">
                    <li class="flex items-center gap-2">
                        <i data-lucide="check-check"
                            class="inline-block size-4 text-green-500 fill-green-100"></i>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <h1 class="mb-4 font-normal"><span class="text-slate-500">$</span>29.99<small
                        class="text-15 text-slate-500">/Monthly</small></h1>
                <button type="button"
                    class="w-full bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600">Purchase
                    Now</button>
        ...
        <div class="relative overflow-hidden card">
            <div class="card-body">
                ...
                <h1 class="mb-4 font-normal"><span class="text-slate-500">$</span>39.99<small
                        class="text-15 text-slate-500">/Monthly</small></h1>
                <button type="button"
                    class="w-full bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600">Purchase
                    Now</button>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <h1 class="mb-4 font-normal"><span class="text-slate-500">$</span>49.99<small
                        class="text-15 text-slate-500">/Monthly</small></h1>
                <button type="button"
                    class="w-full bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600">Purchase
                    Now</button>
            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                    <div class="xl:col-span-8">
                        <p
                            class="relative before:absolute before:border-b before:border-slate-200 before:bottom-2 before:right-0 before:left-0">
                            <span
                                class="relative pr-2 bg-white text-slate-500">Everything
                                Includes</span></p>
                    ...
                    <div class="xl:col-span-4 card bg-custom-500 !mb-0">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                    ...
                    <div class="xl:col-span-4 card bg-purple-100 !mb-0 shadow-none">
                        <div class="flex flex-col h-full card-body">
