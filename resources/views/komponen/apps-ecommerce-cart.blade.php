            ...
            <div class="card products" id="product1">
                <div class="card-body">
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                        <div class="p-4 rounded-md lg:col-span-2 bg-slate-100">
                        ...
                        <div class="flex flex-col lg:col-span-4">
                            <div>
                                ...
                                <p class="mb-2 text-slate-500"><a href="#!">Men's Fashion</a></p>
                                <p class="mb-1 text-slate-500">Color: <span
                                        class="text-slate-800">White/Blue</span></p>
                                <p class="mb-3 text-slate-500">Size: <span
                                        class="text-slate-800">L</span></p>
                            </div>
                            <div class="flex items-center gap-2 mt-auto">
                                <div
                                    class="inline-flex p-2 text-center border rounded input-step border-slate-200">
                                    <button type="button"
                                        class="border w-7 leading-[15px] minus-value bg-slate-200 rounded transition-all duration-200 ease-linear border-slate-200 text-slate-500 hover:bg-custom-500 hover:text-custom-50 hover:border-custom-500 focus:bg-custom-500 focus:border-custom-500 focus:text-custom-50"><i
                                            data-lucide="minus" class="inline-block size-4"></i></button>
                                    <input type="number"
                                        class="text-center ltr:pl-2 rtl:pr-2 w-15 h-7 products-quantity focus:shadow-none"
                                        value="2" min="0" max="100" readonly>
                                    <button type="button"
                                        class="transition-all duration-200 ease-linear border rounded border-slate-200 bg-slate-200 w-7 plus-value text-slate-500 hover:bg-custom-500 hover:text-custom-50 hover:border-custom-500 focus:bg-custom-500 focus:border-custom-500 focus:text-custom-50"><i
                                            data-lucide="plus" class="inline-block size-4"></i></button>
                                </div>
                                <button data-modal-target="deleteModal" type="button"
                                    class="flex items-center justify-center size-[37.5px] p-0 text-red-500 bg-red-100 btn hover:text-white hover:bg-red-600 focus:text-white focus:bg-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:ring active:ring-red-100 remove-button"><i
                        ...
                        <div class="flex justify-between w-full lg:flex-col lg:col-end-13 lg:col-span-2">
                            <div class="mb-auto ltr:lg:text-right rtl:lg:text-left">
                                <h6 class="text-16 products-price">$<span>149.99</span> <small
                                        class="font-normal line-through text-slate-500">$299.99</small>
                                </h6>
                            </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                        ...
                        <div class="flex flex-col lg:col-span-4">
                            <div>
                                ...
                                <p class="mb-2 text-slate-500"><a href="#!">Home, Kitchen, Pets</a>
                                </p>
                                <p class="mb-1 text-slate-500">Color: <span
                                        class="text-slate-800">Green</span></p>
                                <p class="mb-3 text-slate-500">Size: <span
                                        class="text-slate-800">M</span></p>
                            </div>
                            <div class="flex items-center gap-2 mt-auto">
                                <div
                                    class="inline-flex p-2 text-center border rounded input-step border-slate-200">
                        ...
                        <div class="flex justify-between w-full lg:flex-col lg:col-end-13 lg:col-span-2">
                            <div class="mb-auto ltr:lg:text-right rtl:lg:text-left">
                                <h6 class="text-16 products-price">$<span>362.21</span> <small
                                        class="font-normal line-through text-slate-500">$599.99</small>
                                </h6>
                            </div>
                            <h6 class="mt-auto text-16 ltr:lg:text-right rtl:lg:text-left">$<span
                    ...
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                        ...
                        <div class="flex flex-col lg:col-span-4">
                            <div>
                                ...
                                <p class="mb-2 text-slate-500"><a href="#!">Unisex Fashion</a></p>
                                <p class="mb-1 text-slate-500">Color: <span
                                        class="text-slate-800">Black</span></p>
                                <p class="mb-3 text-slate-500">Size: <span
                                        class="text-slate-800">M</span></p>
                            </div>
                            <div class="flex items-center gap-2 mt-auto">
            ...
            <div class="sticky top-[calc(theme('spacing.header')_*_1.3)] mb-5">
                            ...
                            <table class="w-full">
                                <tbody class="table-total">
                                    <tr>
                                        ...
                                        <td class="py-2 text-slate-500 cart-subtotal">
                                            $932.16
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="py-2 text-slate-500 cart-tax">
                                            $167.79
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="py-2 text-slate-500 cart-discount">
                                            -$111.86
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="py-2 text-slate-500 cart-shipping">
                                            $0
                                        </td>
                                    </tr>
                ...
                <div class="flex gap-2 mt-5 shrink-0">
                    <a href="{{ url('apps-ecommerce-product-list') }}"
                        class="w-full text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100">Continue
                        to Shopping</a>
                    <a href="{{ url('apps-ecommerce-checkout') }}"
                        class="w-full text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100">Checkout</a>
                </div>

                <div class="flex items-center gap-5 p-4 mt-5 card">
                    <div class="flex items-center justify-center size-12 rounded-md bg-slate-100">
                        <i data-lucide="truck"
                            class="size-6 text-slate-500 fill-slate-300"></i>
                    </div>
                    <div>
