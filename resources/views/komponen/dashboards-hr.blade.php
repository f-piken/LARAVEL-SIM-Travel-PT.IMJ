    ...
    @section('content')
        ...
        <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
            <div class="col-span-12 md:order-1 xl:col-span-8 2xl:col-span-6">
                ...
                <p class="mb-5 text-slate-500">The salary of <a href="#!"
                        class="underline text-slate-800">Glennie Langosh</a> is pending since 05 Dec, 2023.
            ...
            <div class="col-span-12 md:order-2 xl:col-span-4 2xl:col-start-9 card">
                <div class="p-4">
                    <div class="grid grid-cols-3">
                        <div
                            class="px-4 text-center ltr:border-r rtl:border-l border-slate-200 ltr:last:border-r-0 rtl:last:border-l-0">
                ...
                <div class="card-body">
                    <div class="grid grid-cols-12">
                        <div class="col-span-8 md:col-span-9">
                            <p class="text-slate-500">Total Employee</p>
                    ...
                    <div class="flex items-center gap-3 mt-3">
                        <p class="text-slate-500 grow"><span
            ...
            <div class="col-span-12 md:order-4 lg:col-span-6 2xl:col-span-3 card">
                <div class="card-body">
                    <div class="grid grid-cols-12">
                        <div class="col-span-8 md:col-span-9">
                            <p class="text-slate-500">Total Application</p>
            ...
            <div class="col-span-12 md:order-5 2xl:order-6 lg:col-span-6 2xl:col-span-3 card">
                <div class="card-body">
                    <div class="grid grid-cols-12">
                        <div class="col-span-8 md:col-span-9">
                            <p class="text-slate-500">Hired Candidates</p>
                    ...
                    <div class="flex items-center gap-3 mt-3">
                        <p class="text-slate-500 grow"><span class="font-medium text-red-500">05%</span>
                            Increase</p>
                        <p class="text-slate-500">This Month</p>
                    </div>
                </div>
            ...
            <div class="col-span-12 md:order-6 2xl:order-7 lg:col-span-6 2xl:col-span-3 card">
                <div class="card-body">
                    <div class="grid grid-cols-12">
                        <div class="col-span-8 md:col-span-9">
                            <p class="text-slate-500">Rejected Candidates</p>
                    ...
                    <div class="grid items-center grid-cols-1 gap-3 mb-5 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-4 xl:col-start-10">
                            <div class="flex gap-3">
                                ...
                                <button type="button"
                                    class="bg-white border-dashed shrink-0 text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600"><i
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <div class="flex gap-2">
                                            <div class="size-10 bg-green-100 rounded-full shrink-0">
                                                <img src="{{ URL::asset('build/images/users/avatar-10.png') }}"
                                                    alt="" class="h-10 rounded-full">
                                            </div>
                                            <div class="grow">
                                                <h6>Kristen Redden</h6>
                                                <p class="text-slate-500">kredden@tailwick.com</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td
                                        ...
                                        Designer</td>
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 text-green-500">
                                        Good</td>
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                        <span
                                            class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-green-100 border-green-200 text-green-500">Active</span>
                                    </td>
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                        <div class="flex gap-2">
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                        <div class="flex gap-2">
                                            <div class="size-10 rounded-full bg-sky-100 shrink-0">
                                                <img src="{{ URL::asset('build/images/users/avatar-2.png') }}"
                                                    alt="" class="h-10 rounded-full">
                                            </div>
                                            <div class="grow">
                                                <h6>Howard George</h6>
                                                <p class="text-slate-500">george@tailwick.com</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td
                                    ...
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 text-red-500">
                                        Low</td>
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                        <span
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                        <div class="flex gap-2">
                                            <div class="size-10 rounded-full bg-slate-100 shrink-0">
                                                <img src="{{ URL::asset('build/images/users/avatar-3.png') }}"
                                                    alt="" class="h-10 rounded-full">
                                            </div>
                                            <div class="grow">
                                                <h6>Laura Carlson</h6>
                                                <p class="text-slate-500">carlson15@tailwick.com</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                        <div class="flex gap-2">
                                            <div class="size-10 bg-yellow-100 rounded-full shrink-0">
                                                <img src="{{ URL::asset('build/images/users/avatar-4.png') }}"
                                                    alt="" class="h-10 rounded-full">
                                            </div>
                                            <div class="grow">
                                                <h6>Joseph Hawkins</h6>
                                                <p class="text-slate-500">joseph@tailwick.com</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td
                                    ...
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                        <span
                                            class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-slate-100 border-slate-200 text-slate-500">Disabled</span>
                                    </td>
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                        <div class="flex gap-2">
            ...
            <div
                ...
                <div class="card-body">
                    ...
                    <div class="flex flex-col gap-4 mt-3">
                        <div class="flex gap-3">
                            <div
                                class="flex flex-col items-center justify-center size-12 border rounded-sm border-slate-200 shrink-0">
                                <h6>28</h6> <span class="text-sm text-slate-500">July</span>
                            </div>
                            <div class="grow">
                                <h6 class="mb-1">Meeting with Designer <small
                                        class="inline-block px-2 font-medium border border-transparent rounded text-[11px] py-0.5 bg-slate-100 text-slate-500">09:57
                                        AM</small></h6>
                                <p class="text-slate-500">Created by Admin</p>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            <div
                                class="flex flex-col items-center justify-center size-12 border rounded-sm border-slate-200 shrink-0">
                                <h6>08</h6> <span class="text-sm text-slate-500">June</span>
                            </div>
                            <div class="grow">
                                <h6 class="mb-1">Developing Line Managers Conference <small
                                        class="inline-block px-2 font-medium border border-transparent rounded text-[11px] py-0.5 bg-slate-100 text-slate-500">10:54
                                        AM</small></h6>
                                <p class="text-slate-500">Created by HR</p>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            <div
                                class="flex flex-col items-center justify-center size-12 border rounded-sm border-slate-200 shrink-0">
                                <h6>17</h6> <span class="text-sm text-slate-500">July</span>
                            </div>
                            <div class="grow">
                                <h6 class="mb-1">Airplane in Las Vegas <small
                                        class="inline-block px-2 font-medium border border-transparent rounded text-[11px] py-0.5 bg-slate-100 text-slate-500">12:00
                                        PM</small></h6>
                                <p class="text-slate-500">Created by HR</p>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            <div
                                class="flex flex-col items-center justify-center size-12 border rounded-sm border-slate-200 shrink-0">
                                <h6>11</h6> <span class="text-sm text-slate-500">Nov</span>
                            </div>
                            <div class="grow">
                        ...
                        <div class="flex gap-3">
                            <div
                                class="flex flex-col items-center justify-center size-12 border rounded-sm border-slate-200 shrink-0">
                                <h6>20</h6> <span class="text-sm text-slate-500">Nov</span>
                            </div>
                            <div class="grow">
                                <h6 class="mb-1">Gartner Digital Workplace <small
                                        class="inline-block px-2 font-medium border border-transparent rounded text-[11px] py-0.5 bg-slate-100 text-slate-500">03:49
                                        PM</small></h6>
                                <p class="text-slate-500">Created by HR</p>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            <div
                                class="flex flex-col items-center justify-center size-12 border rounded-sm border-slate-200 shrink-0">
                                <h6>04</h6> <span class="text-sm text-slate-500">Dec</span>
                            </div>
                            <div class="grow">
                                <h6 class="mb-1">Nordic People Analytics <small
                                        class="inline-block px-2 font-medium border border-transparent rounded text-[11px] py-0.5 bg-slate-100 text-slate-500">11:00
                                        AM</small></h6>
                                <p class="text-slate-500">Created by Admin</p>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            <div
                                class="flex flex-col items-center justify-center size-12 border rounded-sm border-slate-200 shrink-0">
                                <h6>17</h6> <span class="text-sm text-slate-500">Jan</span>
                            </div>
                            <div class="grow">
                                <h6 class="mb-1">CIPD Festival of Work <small
                                        class="inline-block px-2 font-medium border border-transparent rounded text-[11px] py-0.5 bg-slate-100 text-slate-500">01:29
                                        PM</small></h6>
                                <p class="text-slate-500">Created by HR</p>
                            </div>
                        </div>
                        <div class="flex gap-3">
                            <div
                                class="flex flex-col items-center justify-center size-12 border rounded-sm border-slate-200 shrink-0">
                                <h6>03</h6> <span class="text-sm text-slate-500">Feb</span>
                            </div>
                            <div class="grow">
                                <h6 class="mb-1">HRO Today Forum <small
                                        class="inline-block px-2 font-medium border border-transparent rounded text-[11px] py-0.5 bg-slate-100 text-slate-500">02:15
                                        PM</small></h6>
                                <p class="text-slate-500">Created by Admin</p>
                            </div>
                        </div>
                ...
                <div class="pb-5">
                    <div data-simplebar class="flex flex-col h-[350px] gap-4 px-5">
                        <div class="flex flex-col gap-3">
                            <div class="border rounded-md border-slate-200">
                                <div class="flex flex-wrap items-center gap-3 p-2">
                                    ...
                                    <div class="grow">
                                        ...
                                        <p class="text-slate-500">james@tailwick.com</p>
                                    </div>
                                    <div class="relative dropdown shrink-0">
                                        <button type="button"
                                            class="flex items-center justify-center size-[30px] p-0 bg-white text-slate-500 btn hover:text-slate-500 hover:bg-slate-100 focus:text-slate-500 focus:bg-slate-100 active:text-slate-500 active:bg-slate-100 dropdown-toggle"
                                ...
                                <div class="p-2 border-t border-slate-200">
                                    <div class="flex flex-col gap-3 md:items-center md:flex-row">
                                        <p class="text-slate-500 shrink-0"><i data-lucide="calendar"
                                                class="inline-block size-4 ltr:mr-1 rtl::ml-1"></i> <span
                                                class="align-middle">25 Nov</span></p>
                                        <p class="text-slate-500 grow"><i data-lucide="clock-4"
                                                class="inline-block size-4 ltr:mr-1 rtl::ml-1"></i> <span
                                                class="align-middle">02:41 PM</span></p>
                                        <span
                                            class="px-2.5 py-0.5 text-xs inline-block text-center font-medium shrink-0 rounded border bg-white border-green-400 text-green-500">Confirm</span>
                                    </div>
                                </div>
                            </div>
                            <div class="border rounded-md border-slate-200">
                                <div class="flex flex-wrap items-center gap-3 p-2">
                                    ...
                                    <div class="grow">
                                        ...
                                        <p class="text-slate-500">michaelScott@tailwick.com</p>
                                    </div>
                                    <div class="relative dropdown shrink-0">
                                        <button type="button"
                                            class="flex items-center justify-center size-[30px] p-0 bg-white text-slate-500 btn hover:text-slate-500 hover:bg-slate-100 focus:text-slate-500 focus:bg-slate-100 active:text-slate-500 active:bg-slate-100 dropdown-toggle"
                                ...
                                <div class="p-2 border-t border-slate-200">
                                    <div class="flex flex-col gap-3 md:items-center md:flex-row">
                                        ...
                                        <span
                                            class="px-2.5 py-0.5 text-xs text-center inline-block font-medium shrink-0 rounded border bg-white border-custom-400 text-custom-500">Re-scheduled</span>
                                    </div>
                                </div>
                            </div>
                            <div class="border rounded-md border-slate-200">
                                <div class="flex flex-wrap items-center gap-3 p-2">
                                    ...
                                    <div class="grow">
                                        ...
                                        <p class="text-slate-500">ledford@tailwick.com</p>
                                    </div>
                                    <div class="relative dropdown shrink-0">
                                        <button type="button"
                                            class="flex items-center justify-center size-[30px] p-0 bg-white text-slate-500 btn hover:text-slate-500 hover:bg-slate-100 focus:text-slate-500 focus:bg-slate-100 active:text-slate-500 active:bg-slate-100 dropdown-toggle"
                                ...
                                <div class="p-2 border-t border-slate-200">
                                    <div class="flex flex-col gap-3 md:items-center md:flex-row">
                                        ...
                                        <span
                                            class="px-2.5 py-0.5 text-xs inline-block text-center font-medium shrink-0 rounded border bg-white border-sky-400 text-sky-500">Scheduled</span>
                                    </div>
                                </div>
                            </div>
                            <div class="border rounded-md border-slate-200">
                                <div class="flex flex-wrap items-center gap-3 p-2">
                                    ...
                                    <div class="grow">
                                        ...
                                        <p class="text-slate-500">gap-4@tailwick.com</p>
                                    </div>
                                    <div class="relative dropdown shrink-0">
                                        <button type="button"
                                            class="flex items-center justify-center size-[30px] p-0 bg-white text-slate-500 btn hover:text-slate-500 hover:bg-slate-100 focus:text-slate-500 focus:bg-slate-100 active:text-slate-500 active:bg-slate-100 dropdown-toggle"
                                ...
                                <div class="p-2 border-t border-slate-200">
                                    <div class="flex flex-col gap-3 md:items-center md:flex-row">
                                        ...
                                        <span
                                            class="px-2.5 py-0.5 text-xs inline-block text-center font-medium shrink-0 rounded border bg-white border-red-400 text-red-500">Cancelled</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-span-12 md:order-12 lg:col-span-12 xl:col-span-8 2xl:col-span-3">
                <div class="grid grid-cols-12 gap-x-5">
                    <div
                        class="relative col-span-12 card bg-gradient-to-r to-custom-100 from-transparent">
                        <div class="bg-[url('../images/hr-dashboard.png')] absolute inset-0 bg-cover opacity-30"></div>
                        <div class="relative card-body">
                            <div class="flex gap-3 mb-4">
                                <div class="size-10 bg-purple-100 rounded-full shrink-0">
                                    <img src="{{ URL::asset('build/images/users/avatar-6.png') }}" alt=""
                                        class="h-10 rounded-full">
                                </div>
                                <div class="grow">
                                    <h6 class="mb-1">Nakisha Short</h6>
                                    <p class="text-slate-500">Her Birthday Today</p>
                                </div>
                            </div>
                            <button type="button"
                                ...
                                <div class="flex flex-col gap-3">
                                    <div class="flex flex-wrap items-center gap-3">
                                        ...
                                        <div class="w-20 ltr:text-right rtl:text-left shrink-0">
                                            <span
                                                class="px-2.5 py-0.5 inline-block text-[11px] font-medium rounded border bg-green-100 border-transparent text-green-500">Paid</span>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap items-center gap-3">
                                        <div
                                        ...
                                        <div class="w-20 ltr:text-right rtl:text-left shrink-0">
                                            <span
                                                class="px-2.5 py-0.5 inline-block text-[11px] font-medium rounded border bg-yellow-100 border-transparent text-yellow-500">Pending</span>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap items-center gap-3">
                                        <div
                                    ...
                                    <div class="flex flex-wrap items-center gap-3">
                                        ...
                                        <div class="w-20 ltr:text-right rtl:text-left shrink-0">
                                            <span
                                                class="px-2.5 py-0.5 inline-block text-[11px] font-medium rounded border bg-red-100 border-transparent text-red-500">Cancelled</span>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap items-center gap-3">
                                        <div
