...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-x-5">
        <div
            class="order-1 md:col-span-6 lg:col-span-3 col-span-12 2xl:order-1 bg-green-100 card 2xl:col-span-2 group-data-[skin=bordered]:border-green-500/20 relative overflow-hidden">
            <div class="card-body">
                <i data-lucide="kanban"
                    class="absolute top-0 size-32 stroke-1 text-green-200/50 ltr:-right-10 rtl:-left-10"></i>
        ...
        <div
            class="order-2 md:col-span-6 lg:col-span-3 col-span-12 2xl:order-1 bg-orange-100 card 2xl:col-span-2 group-data-[skin=bordered]:border-orange-500/20 relative overflow-hidden">
            <div class="card-body">
                <i data-lucide="list-filter"
                    class="absolute top-0 size-32 stroke-1 text-orange-200/50 ltr:-right-10 rtl:-left-10"></i>
                ...
                <p class="text-slate-500">Sessions</p>
            </div>
        </div><!--end col-->
            ...
            <div class="card-body">
                <div class="flex items-center gap-2 mb-3">
                    ...
                    <div class="relative dropdown shrink-0">
                        <span class="ltr:mr-1 rtl:ml-1 text-slate-500">Sort by</span>
                        <button type="button"
                            class="px-2 py-1.5 text-xs bg-white border-dashed text-slate-500 btn border-slate-500 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-600 focus:text-slate-600 focus:bg-slate-50 focus:border-slate-600 active:text-slate-600 active:bg-slate-50 active:border-slate-600 dropdown-toggle"
        ...
        <div
            class="order-3 md:col-span-6 lg:col-span-3 col-span-12 2xl:order-1 bg-sky-100 card 2xl:col-span-2 group-data-[skin=bordered]:border-sky-500/20 relative overflow-hidden">
            <div class="card-body">
                <i data-lucide="list-filter"
                    class="absolute top-0 size-32 stroke-1 text-sky-200/50 ltr:-right-10 rtl:-left-10"></i>
                ...
                <p class="text-slate-500">Avg. Visit Duration</p>
            </div>
        </div><!--end col-->
        <div
            class="order-4 md:col-span-6 lg:col-span-3 col-span-12 2xl:order-1 bg-purple-100 card 2xl:col-span-2 group-data-[skin=bordered]:border-purple-500/20 relative overflow-hidden">
            <div class="card-body">
                <i data-lucide="kanban"
                    class="absolute top-0 size-32 stroke-1 text-purple-200/50 ltr:-right-10 rtl:-left-10"></i>
                ...
                <p class="text-slate-500">Bounce Rate</p>
            </div>
        </div><!--end col-->
        <div class="order-6 col-span-12 2xl:order-1 card 2xl:col-span-5">
            <div class="card-body">
                <div class="flex items-center gap-2">
                    ...
                    <div class="shrink-0">
                        <button type="button"
                            class="px-2 py-1.5 text-xs text-custom-500 btn bg-custom-100 hover:text-white hover:bg-custom-600 focus:text-white focus:bg-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:ring active:ring-custom-100">
        ...
        <div class="order-7 col-span-12 2xl:order-1 card 2xl:col-span-7">
            <div class="card-body">
                <div class="flex items-center gap-2">
                    ...
                    <div class="relative dropdown shrink-0">
                        <button type="button"
                            class="px-2 py-1.5 text-xs bg-text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100 dropdown-toggle"
                            id="emailDataDropdown" data-bs-toggle="dropdown">
                            This Yearly <i data-lucide="chevron-down" class="inline-block size-4 ltr:ml-1 rlt:mr-1"></i>
                        </button>
            ...
            <div class="card-body">
                <div class="flex items-center gap-2 mb-3">
                    <h6 class="text-15 grow">User Device <a href="#!" data-tooltip="default"
                            ...
                            class="inline-block align-middle ltr:ml-1 rtl:mr-1 text-slate-500"><i
        ...
        <div class="order-9 col-span-12 lg:col-span-6 2xl:order-1 card 2xl:col-span-4">
            <div class="card-body">
                ...
                <p class="text-center text-15 text-slate-500">Based on Likes 💖</p>
            </div>
        </div><!--end col-->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-green-100 border-transparent text-green-500"><i
                            ...
                            <tr>
                                ...
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-red-100 border-transparent text-red-500"><i
            ...
            <div class="card-body">
                ...
                <ul class="flex flex-col gap-5">
                    <li class="flex items-center gap-3">
                        <div
                            class="flex items-center justify-center size-8 text-red-500 bg-red-100 rounded-md shrink-0">
                            <i data-lucide="mail" class="size-4"></i>
                        </div>
                        <h6 class="grow">Clicked</h6>
                        <p class="text-slate-500">9,745</p>
                    ...
                    <li class="flex items-center gap-3">
                        <div
                            class="flex items-center justify-center size-8 rounded-md text-sky-500 bg-sky-100 shrink-0">
                            <i data-lucide="users-2" class="size-4"></i>
                        </div>
                        <h6 class="grow">Subscribe</h6>
                        <p class="text-slate-500">3,352</p>
                        <div class="w-12 text-green-500 ltr:text-right rtl:text-left">
                            18.9%
                        </div>
                    </li>
                    <li class="flex items-center gap-3">
                        <div
                            class="flex items-center justify-center size-8 text-orange-500 bg-orange-100 rounded-md shrink-0">
                            <i data-lucide="user-x-2" class="size-4"></i>
                        </div>
                        <h6 class="grow">Unsubscribe</h6>
                        <p class="text-slate-500">85,745</p>
                    ...
                    <li class="flex items-center gap-3">
                        <div
                            class="flex items-center justify-center size-8 text-green-500 bg-green-100 rounded-md shrink-0">
                    ...
                    <li class="flex items-center gap-3">
                        <div
                            class="flex items-center justify-center size-8 rounded-md text-slate-500 bg-slate-100 shrink-0">
                ...
                <div class="flex flex-col gap-5">
                    <div>
                        <div class="flex items-center justify-between gap-4 mb-2">
                            <h6>Google</h6>
                            <span class="text-slate-500">54,963</span>
                        </div>
                        <div class="w-full h-3.5 rounded bg-slate-200">
                    ...
                    <div>
                        ...
                        <div class="w-full h-3.5 rounded bg-slate-200">
                            <div class="h-3.5 rounded bg-slate-500" style="width: 25%"></div>
                        </div>
                    </div>
                </div>
            </div>
