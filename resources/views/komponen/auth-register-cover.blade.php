        ...
        <div class="mb-0 border-none lg:w-[500px] card bg-white/70 shadow-none">
            <div class="!px-10 !py-12 card-body">
                ...
                <div class="mt-8 text-center">
                    <h4 class="mb-1 text-custom-500">Create your free account</h4>
                    <p class="text-slate-500">Get your free Tailwick account now</p>
                </div>
                ...
                <form action="#!" class="mt-10" id="registerForm">
                    ...
                    <p class="italic text-15 text-slate-500">By registering you agree to the Tailwick <a
