...
@section('content')
        ...
        <div class="col-span-12 lg:col-span-3 2xl:col-span-2 shrink-0 card">
            <div class="card-body">
                <button type="button" data-modal-target="addEmailModal"
                    class="w-full text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100"><i
                        data-lucide="plus" class="inline-block size-4 mr-1"></i> <span class="align-middle">Compose
                        Email</span></button>
                <ul class="mt-4">
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500"><i
                ...
                <div class="card-body">
                    <div class="grid items-center grid-cols-1 gap-4 2xl:grid-cols-12">
                        <div class="2xl:col-span-5">
                            <div
                                class="flex flex-wrap items-center gap-3 divide-x rtl:divide-x-reverse divide-slate-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <a href="#!"
                                        class="flex items-center justify-center size-6 transition-all duration-200 ease-linear text-slate-500 hover:text-slate-600"><i
                                            data-lucide="refresh-cw" class="size-4"></i></a>
                                </div>
                                <div class="flex items-center gap-3 ltr:pl-2 rtl:pr-2">
                                    <a href="#!"
                                        class="flex items-center justify-center size-6 transition-all duration-200 ease-linear text-slate-500 hover:text-custom-500"><i
                                            data-lucide="archive-restore" class="size-4"></i></a>
                                    <a href="#!"
                                        class="flex items-center justify-center size-6 transition-all duration-200 ease-linear text-slate-500 hover:text-orange-500"><i
                                            data-lucide="alert-octagon" class="size-4"></i></a>
                                    <a href="#!"
                                        class="flex items-center justify-center size-6 transition-all duration-200 ease-linear text-slate-500 hover:text-red-500"
                                        data-modal-target="deleteModal"><i data-lucide="trash-2" class="size-4"></i></a>
                                </div>
                                <div class="flex items-center gap-3 ltr:pl-2 rtl:pr-2">
                                    <a href="#!"
                                        class="flex items-center justify-center size-6 transition-all duration-200 ease-linear text-slate-500 hover:text-custom-500"
                                        id="mark-all-read"><i data-lucide="mail" class="size-4"></i></a>
                                    <a href="#!"
                                        class="flex items-center justify-center size-6 transition-all duration-200 ease-linear text-slate-500 hover:text-green-500"><i
                                            data-lucide="tag" class="size-4"></i></a>
                                    <a href="#!"
                                        class="flex items-center justify-center size-6 transition-all duration-200 ease-linear text-slate-500 hover:text-sky-500"><i
                                            data-lucide="clock" class="size-4"></i></a>
                                </div>
                                <div class="hidden px-4 py-3 text-sm text-yellow-500 border border-transparent rounded-md unreadConversations-alert bg-yellow-50" id="unreadConversations">
                        ...
                        <div class="flex items-center gap-2 2xl:col-span-4 2xl:col-start-9">
                            ...
                            <div class="relative dropdown shrink-0">
                                <button id="emailMainAction" data-bs-toggle="dropdown"
                                    class="flex items-center justify-center w-[39px] h-[39px] dropdown-toggle p-0 text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100"><i
                                        data-lucide="more-horizontal" class="size-5"></i></button>
                                <ul class="absolute z-50 hidden py-2 mt-1 text-left list-none bg-white rounded-md shadow-md dropdown-menu min-w-max"
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full whitespace-nowrap">
                                <tbody class="elmLoader" id="mail-list">
                                    <tr>
                                        <td colspan="3">
                                            <p class="mb-2 text-slate-500">Today</p>
                                        </td>
                                    </tr>
                                    <tr
                                        ...
                                        <td class="px-3.5 py-2.5 border-y border-transparent first:pl-0 last:pr-0 w-20">
                                            <div class="flex items-center gap-3 ltr:pl-2 rtl:pr-2 checkbox-wrapper-mail">
                                                <input id="checkbox"
                                                    ...
                                                    type="checkbox">
                                                <a href="#!"
                                                    class="transition-all duration-200 ease-linear text-slate-500 hover:text-yellow-500"><i
                                        ...
                                        <td
                                            class="px-3.5 py-2.5 border-y border-transparent  mailBox first:pl-0 last:pr-0 text-slate-500 group-[.unread]/mail:text-slate-800">
                                        ...
                                        <td
                                            class="px-3.5 py-2.5 border-y border-transparent first:pl-0 last:pr-0 text-end w-20 text-slate-500 group-[.unread]/mail:text-slate-800">
                                            01:20 AM</td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="card-body">
                    <div class="flex gap-2">
                        <div class="grow">
                            ...
                            <p class="text-slate-500"><a href="#!">infrateach@tailwick.com</a>
                        ...
                        <div class="flex gap-3 shrink-0">
                            ...
                            <a href="#!"
                                class="flex items-center justify-center size-6 transition-all duration-200 ease-linear text-slate-500 hover:text-yellow-500"><i
                                    data-lucide="star" class="size-4"></i></a>
                            <a href="#!"
                                class="flex items-center justify-center size-6 transition-all duration-200 ease-linear text-slate-500 hover:text-red-500"><i
                ...
                <div class="xl:max-h-[calc(100vh_-_385px)]" data-simplebar>
                    <div class="card-body !pt-0">
                        <div class="flex gap-3 mt-3 first:mt-0">
                            <div
                                class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 size-9 bg-slate-100 shrink-0">
                            ...
                            <div class="grow">
                                ...
                                <div class="p-4 mt-3 rounded-md bg-slate-100">
                        ...
                        <div class="flex gap-3 mt-3 first:mt-0">
                            <div
                                class="relative flex items-center justify-center font-semibold bg-pink-100 rounded-full text-slate-500 size-9 shrink-0">
    ...
    <div id="addEmailModal" modal-center
        ...
        <div class="w-screen lg:w-[55rem] bg-white shadow rounded-md">
