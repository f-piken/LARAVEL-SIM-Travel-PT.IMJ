        ...
        <div class="card-body">
                ...
                <table class="w-full whitespace-nowrap">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                <span
                                    class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-green-100 border-transparent text-green-500">Accepted</span>
                            </td>
                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                <span
                                    class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-orange-100 border-transparent text-orange-500">Expired</span>
                            </td>
                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200">
                                <div class="relative dropdown">
            ...
            <div class="flex flex-col items-center mt-5 md:flex-row">
                <div class="mb-4 grow md:mb-0">
                    <p class="text-slate-500">Showing <b>6</b> of <b>8</b> Results</p>
                </div>
