            ...
            <div class="overflow-x-auto">
                <table class="w-full whitespace-nowrap" id="productTable">
                    <thead class="ltr:text-left rtl:text-right bg-slate-100">
                        <tr>
                            <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 sort product_code"
                                data-sort="product_code">Product Code</th>
                            <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 sort product_name"
                                data-sort="product_name">Product Name</th>
                            <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 sort category"
                                data-sort="category">Category</th>
                            <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 sort price"
                                data-sort="price">Price</th>
                            <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 sort stock"
                                data-sort="stock">Stock</th>
                            <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 sort revenue"
                                data-sort="revenue">Revenue</th>
                            <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 sort status"
                    ...
                    <tbody class="list">
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 product_name">
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 category">
                                <span
                                    class="category px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-slate-100 border-slate-200 text-slate-500">Fashion</span>
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 price">$79.99</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 stock">500</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 revenue">$24,365</td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 status">
                                <span
                                    class="status px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-orange-100 border-transparent text-orange-500">Scheduled</span>
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 action">
                ...
                <div class="noresult" style="display: none">
                    <div class="py-6 text-center">
                        <i data-lucide="search"
                            class="size-6 mx-auto mb-3 text-sky-500 fill-sky-100"></i>
                        <h5 class="mt-2 mb-1">Sorry! No Result Found</h5>
                        <p class="mb-0 text-slate-500">We've searched more than 199+ product We did not
