...
@section('content')
                ...
                <div class="lg:col-span-10 2xl:col-span-9">
                    ...
                    <div class="flex gap-3 mb-4">
                        <p class="text-slate-500"><i data-lucide="user-circle"
                            ...
                            CEO & Founder</p>
                        <p class="text-slate-500"><i data-lucide="map-pin"
                                class="inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500 fill-slate-100"></i>
                            Los Angeles, California</p>
                    </div>
                    <ul
                        class="flex flex-wrap gap-3 mt-4 text-center divide-x divide-slate-200 rtl:divide-x-reverse">
                        <li class="px-5">
                            <h5>1542</h5>
                    ...
                    <p class="mt-4 text-slate-500">Strong leader and negotiator adept at driving
                    ...
                    <div class="flex gap-2 mt-4">
                        <a href="#!"
                            class="flex items-center justify-center transition-all duration-200 ease-linear rounded size-9 text-sky-500 bg-sky-100 hover:bg-sky-200">
                            <i data-lucide="facebook" class="size-4"></i>
                        </a>
                        <a href="#!"
                            class="flex items-center justify-center text-pink-500 transition-all duration-200 ease-linear bg-pink-100 rounded size-9 hover:bg-pink-200">
                            <i data-lucide="instagram" class="size-4"></i>
                        </a>
                        <a href="#!"
                            class="flex items-center justify-center text-red-500 transition-all duration-200 ease-linear bg-red-100 rounded size-9 hover:bg-red-200">
                            <i data-lucide="globe" class="size-4"></i>
                        </a>
                        <a href="#!"
                            class="flex items-center justify-center transition-all duration-200 ease-linear rounded text-custom-500 bg-custom-100 size-9 hover:bg-custom-200">
                        ...
                        <a href="#!"
                            class="flex items-center justify-center transition-all duration-200 ease-linear rounded size-9 text-slate-500 bg-slate-100 hover:bg-slate-200">
                ...
                <div class="lg:col-span-12 2xl:col-span-2">
                    <div class="flex gap-2 2xl:justify-end">
                        ...
                        <div class="relative dropdown">
                            <button
                                class="flex items-center justify-center size-[37.5px] dropdown-toggle p-0 text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100"
                            ...
                            <ul class="absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem]"
                                ...
                                <li>
                                    <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500"
            ...
            <ul class="flex flex-wrap w-full text-sm font-medium text-center nav-tabs">
                <li class="group active">
                    <a href="javascript:void(0);" data-tab-toggle data-target="overviewTabs"
                        class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 -mb-[1px]">Overview</a>
                </li>
                <li class="group">
                    <a href="javascript:void(0);" data-tab-toggle data-target="documentsTabs"
                        class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 -mb-[1px]">Documents</a>
                </li>
                <li class="group">
                    <a href="javascript:void(0);" data-tab-toggle data-target="projectsTabs"
                        class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 -mb-[1px]">Projects</a>
                </li>
                <li class="group">
                    <a href="javascript:void(0);" data-tab-toggle data-target="followersTabs"
                        class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 -mb-[1px]">Followers</a>
                </li>
            </ul>
        </div>
    </div><!--end card-->
    ...
    <div class="tab-content">
                ...
                <div class="2xl:col-span-9">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-2 text-slate-500">A Web Developer creates and designs different
                            ...
                            <p class="text-slate-500">As a web designer, my objective is to make a
                                ...
                                <table class="w-full ltr:text-left rtl:ext-right">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="py-2 text-right text-slate-500">CEO & Founder
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="py-2 font-semibold ps-0" scope="row">Phone No</th>
                                            <td class="py-2 text-right text-slate-500">617 219 6245</td>
                                        </tr>
                                        <tr>
                                            <th class="py-2 font-semibold ps-0" scope="row">Birth of Date</th>
                                            <td class="py-2 text-right text-slate-500">15 Dec, 1998</td>
                                        </tr>
                                        <tr>
                                            <th class="py-2 font-semibold ps-0" scope="row">Website</th>
                                            <td class="py-2 text-right text-slate-500"><a
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-2 text-right text-slate-500">Los Angeles,
                                                California</td>
                                        </tr>
                                        <tr>
                                            <th class="pt-2 font-semibold ps-0" scope="row">Joining Date</th>
                                            <td class="pt-2 text-right text-slate-500">01 July 2023</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="divide-y divide-slate-200">
                                <div class="flex items-center gap-3 pb-3">
                                    <div
                                        class="flex items-center justify-center size-12 rounded-full bg-slate-100">
                                        <i data-lucide="wallet" class="size-5 text-slate-500"></i>
                                    </div>
                                    <div>
                                        <h6 class="text-lg">$245.98</h6>
                                        <p class="text-slate-500">Total Earning</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 py-3">
                                    <div
                                        class="flex items-center justify-center size-12 rounded-full bg-slate-100">
                                        <i data-lucide="goal" class="size-5 text-slate-500"></i>
                                    </div>
                                    <div>
                                        <h6 class="text-lg">$125.23</h6>
                                        <p class="text-slate-500">Items Earning</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 pt-3">
                                    <div
                                        class="flex items-center justify-center size-12 rounded-full bg-slate-100">
                                        <i data-lucide="package" class="size-5 text-slate-500"></i>
                                    </div>
                                    <div>
                                        <h6 class="text-lg">$21.49</h6>
                                        <p class="text-slate-500">Contributor Bonus</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full whitespace-nowrap">
                                <thead class="ltr:text-left rtl:text-right">
                                    <tr>
                                        <th
                                            class="px-3.5 py-2.5 font-semibold border-b border-slate-200">
                                            Date</th>
                                        <th
                                            class="px-3.5 py-2.5 font-semibold border-b border-slate-200">
                                            Amount</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">2 April,
                                            2023</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">$321.00
                                        </td>
                                        <td
                                            class="px-3.5 py-2.5 border-y border-slate-200 text-green-500">
                                            Paid</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">
                                            Subscription</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200"><a
                                                href="#!"
                                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600"><i
                                                    class="ri-download-2-line"></i></a></td>
                                    </tr>
                                    <tr>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">8 June,
                                            2023</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">$184.00
                                        </td>
                                        <td
                                            class="px-3.5 py-2.5 border-y border-slate-200 text-yellow-500">
                                            Pending</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">April
                                            Autofile</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200"><a
                                                href="#!"
                                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600"><i
                                    ...
                                    <tr>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">15 July,
                                            2023</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">$325.00
                                        </td>
                                        <td
                                            class="px-3.5 py-2.5 border-y border-slate-200 text-yellow-500">
                                            Pending</td>
                                    ...
                                    <tr>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">29 July,
                                            2023</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">$321.00
                                        </td>
                                        <td
                                            class="px-3.5 py-2.5 border-y border-slate-200 text-green-500">
                                            Paid</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">Prepaid
                                            Bill</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200"><a
                                                href="#!"
                                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600"><i
                                    ...
                                    <tr>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">12 Aug,
                                            2023</td>
                                        <td class="px-3.5 py-2.5 border-y border-slate-200">$189.99
                                        </td>
                                        <td
                                            class="px-3.5 py-2.5 border-y border-slate-200 text-green-500">
                                            Paid</td>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="#!"
                                class="flex items-center gap-3 p-2 border rounded-md border-slate-200">
                                ...
                                <div class="grow">
                                    ...
                                    <p class="text-sm text-slate-500">XXXX XXXX XXXX 1501</p>
                                </div>
                                <div>
                                    <span
                                        class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-sky-100 border-transparent text-sky-500">Primary</span>
                                </div>
                            </a>
                            <a href="#!"
                                class="flex items-center gap-3 p-2 border rounded-md border-slate-200">
                                ...
                                <div class="grow">
                                    ...
                                    <p class="text-sm text-slate-500">XXXX XXXX XXXX 9871</p>
                                </div>
                            </a>
                            <a href="#!"
                                class="flex items-center gap-3 p-2 border rounded-md border-slate-200">
                                ...
                                <div class="grow">
                                    ...
                                    <p class="text-sm text-slate-500">XXXX XXXX XXXX 7435</p>
                                </div>
                            </a>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 gap-5 mb-3 md:grid-cols-3">
                            <div>
                                <p class="mb-1 text-slate-500">Plan Type</p>
                                <h6>Regular Plan</h6>
                            </div><!--end col-->
                            <div>
                                <p class="mb-1 text-slate-500">Monthly Limit</p>
                                <h6>2 Download</h6>
                            </div><!--end col-->
                            <div>
                                <p class="mb-1 text-slate-500">Cost</p>
                                <h6>$26/Monthly</h6>
                            </div><!--end col-->
                        </div><!--end grid-->
                        <div
                            class="px-4 py-3 mb-2 text-sm rounded-md text-slate-500 bg-slate-50">
                            ...
                            <p>After this date, our pricing will transition to $22. For more details, click <a
                                    href="#!" class="font-semibold text-slate-700">Learn More</a>
                            </p>
                        </div>
                        <p class="mb-2 text-slate-500">Plan Benefits</p>
        ...
        <div class="hidden tab-pane" id="documentsTabs">
                ...
                <table class="w-full align-middle border-separate whitespace-nowrap border-spacing-y-1">
                        ...
                        <tr>
                            <th class="px-3.5 py-2.5 font-semibold border-b border-transparent">
                                <div class="flex items-center h-full">
                                    <input id="Checkbox1"
                                        class="size-4 bg-white border border-slate-200 checked:bg-none rounded-sm appearance-none arrow-none relative after:absolute after:content-['\eb7b'] after:top-0 after:left-0 after:font-remix after:leading-none after:opacity-0 checked:after:opacity-100 after:text-custom-500 checked:border-custom-500"
                                        type="checkbox" value="">
                                </div>
                            </th>
                    ...
                    <tbody>
                        <tr class="bg-white">
                            ...
                            <td class="px-3.5 py-2.5 border-y border-transparent">
                                <span
                                    class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-slate-100 border-transparent text-slate-500">Docs</span>
                            </td>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-transparent"><span
                                    class="ppx-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-green-100 border-transparent text-green-500">Successful</span>
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-transparent">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="#!"
                                        class="flex items-center justify-center size-8 transition-all duration-150 ease-linear rounded-md bg-slate-100 hover:bg-slate-200"><i
                        ...
                        <tr class="bg-white">
                            ...
                            <td class="px-3.5 py-2.5 border-y border-transparent">
                                <span
                                    class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-slate-100 border-transparent text-slate-500">PSD</span>
                            </td>
                        ...
                        <tr class="bg-white">
                            ...
                            <td class="px-3.5 py-2.5 border-y border-transparent">
                                <span
                                    class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-slate-100 border-transparent text-slate-500">SVG</span>
                            </td>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-transparent">Admin</td>
                            <td class="px-3.5 py-2.5 border-y border-transparent"><span
                                    class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-red-100 border-transparent text-red-500">Error</span>
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-transparent">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="#!"
                        ...
                        <tr class="bg-white">
                            ...
                            <td class="px-3.5 py-2.5 border-y border-transparent">
                                <span
                                    class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-slate-100 border-transparent text-slate-500">SCSS</span>
                            </td>
                        ...
                        <tr class="bg-white">
                            ...
                            <td class="px-3.5 py-2.5 border-y border-transparent">
                                <span
                                    class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-slate-100 border-transparent text-slate-500">MP4</span>
                            </td>
            ...
            <div class="flex flex-col items-center gap-4 mt-4 mb-4 md:flex-row">
                <div class="grow">
                    <p class="text-slate-500">Showing <b>6</b> of <b>18</b> Results</p>
                </div>
        ...
        <div class="hidden tab-pane" id="projectsTabs">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-slate-500">Allows you to communicate with your customers in
                                web chat rooms.</p>
                        </div>
                        <div
                            class="flex w-full gap-3 mt-6 text-center divide-x divide-slate-200 rtl:divide-x-reverse">
                            <div class="px-3 grow">
                        ...
                        <div class="w-full h-1.5 mt-6 rounded-full bg-slate-100">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-slate-500">UX design process is iterative and non-linear,
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-slate-500">The process of tailoring the overall project
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-slate-500">Drawing created with Microsoft Expression Design,
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-slate-500">The strategic approach to nurturing and supporting
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-slate-500">A personal budget app is a technology solution
                                that is connected.</p>
                        </div>
                        <div
                            class="flex w-full gap-3 mt-6 text-center divide-x divide-slate-200 rtl:divide-x-reverse">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-slate-500">An email template is an HTML preformatted email
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-slate-500">Bank management refers to the process of managing
            ...
            <div class="flex flex-col items-center gap-4 mt-2 mb-4 md:flex-row">
                <div class="grow">
                    <p class="text-slate-500">Showing <b>8</b> of <b>30</b> Results</p>
                </div>
                <ul class="flex flex-wrap items-center gap-2 shrink-0">
                    <li>
                        <a href="#!"
        ...
        <div class="hidden tab-pane" id="followersTabs">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 gap-x-5">
                <div class="relative card">
                    <div class="card-body">
                        <p
                            class="absolute inline-block px-5 py-1 text-xs ltr:left-0 rtl:right-0 text-custom-600 bg-custom-100 top-5 ltr:rounded-e rtl:rounded-l">
                            Executive Operations</p>
                        <div class="flex items-center justify-end">
                            <p class="text-slate-500">Doj : 15 Jan, 2023</p>
                        </div>
                        <div class="mt-4 text-center">
                            ...
                            <div class="text-slate-500">
                                ...
                                <p
                                    class="inline-block px-3 py-1 my-4 font-semibold rounded-md text-slate-600 bg-slate-100">
                                    Exp. : 1.5 years</p>
                                <h4 class="text-15 text-custom-500">Salary : $463.42 <span
                                        class="text-xs font-normal text-slate-500">/ Month<span></h4>
                            </div>
                        </div>
                    </div>
                </div><!--end card-->
                <div class="relative card">
                    <div class="card-body">
                        <p
                            class="absolute inline-block px-5 py-1 text-xs text-green-600 bg-green-100 ltr:left-0 rtl:right-0 top-5 ltr:rounded-e rtl:rounded-l">
                            Project Manager</p>
                        <div class="flex items-center justify-end">
                            <p class="text-slate-500">Doj : 29 Feb, 2023</p>
                        </div>
                        <div class="mt-4 text-center">
                            <div class="flex justify-center">
                                <div class="size-20 overflow-hidden rounded-full bg-slate-100">
                ...
                <div class="relative card">
                    <div class="card-body">
                        <p
                            class="absolute inline-block px-5 py-1 text-xs ltr:left-0 rtl:right-0 text-sky-600 bg-sky-100 top-5 ltr:rounded-e rtl:rounded-l">
                            React Developer</p>
                        <div class="flex items-center justify-end">
                            <p class="text-slate-500">Doj : 04 March, 2023</p>
                        </div>
                        <div class="mt-4 text-center">
                            <div class="flex justify-center">
                                <div class="size-20 overflow-hidden rounded-full bg-slate-100">
                ...
                <div class="relative card">
                    <div class="card-body">
                        <p
                            class="absolute inline-block px-5 py-1 text-xs text-yellow-600 bg-yellow-100 ltr:left-0 rtl:right-0 top-5 ltr:rounded-e rtl:rounded-l">
                            Shopify Developer</p>
                        <div class="flex items-center justify-end">
                            <p class="text-slate-500">Doj : 11 March, 2023</p>
                        </div>
                        <div class="mt-4 text-center">
                            <div class="flex justify-center">
                                <div class="size-20 overflow-hidden rounded-full bg-slate-100">
                ...
                <div class="relative card">
                    <div class="card-body">
                        <p
                            class="absolute inline-block px-5 py-1 text-xs text-red-600 bg-red-100 ltr:left-0 rtl:right-0 top-5 ltr:rounded-e rtl:rounded-l">
                            Angular Developer</p>
                        <div class="flex items-center justify-end">
                            <p class="text-slate-500">Doj : 22 March, 2023</p>
                        </div>
                        <div class="mt-4 text-center">
                            <div class="flex justify-center">
                                <div class="size-20 overflow-hidden rounded-full bg-slate-100">
                ...
                <div class="relative card">
                    <div class="card-body">
                        <p
                            class="absolute inline-block px-5 py-1 text-xs text-purple-600 bg-purple-100 ltr:left-0 rtl:right-0 top-5 ltr:rounded-e rtl:rounded-l">
                            Graphic Designer</p>
                        <div class="flex items-center justify-end">
                            <p class="text-slate-500">Doj : 09 June, 2023</p>
                        </div>
                        <div class="mt-4 text-center">
                            <div class="flex justify-center">
                                <div class="size-20 overflow-hidden rounded-full bg-slate-100">
                ...
                <div class="relative card">
                    <div class="card-body">
                        <p
                            ...
                            Shopify Developer</p>
                        <div class="flex items-center justify-end">
                            <p class="text-slate-500">Doj : 27 June, 2023</p>
                        </div>
                        <div class="mt-4 text-center">
                            <div class="flex justify-center">
                                <div class="size-20 overflow-hidden rounded-full bg-slate-100">
                ...
                <div class="relative card">
                    <div class="card-body">
                        <p
                            class="absolute inline-block px-5 py-1 text-xs text-orange-600 bg-orange-100 ltr:left-0 rtl:right-0 top-5 ltr:rounded-e rtl:rounded-l">
                            Team Leader</p>
                        <div class="flex items-center justify-end">
                            <p class="text-slate-500">Doj : 15 July, 2023</p>
                        </div>
                        <div class="mt-4 text-center">
                            <div class="flex justify-center">
                                <div class="size-20 overflow-hidden rounded-full bg-slate-100">
            ...
            <div class="flex flex-col items-center gap-4 mb-4 md:flex-row">
                <div class="grow">
                    <p class="text-slate-500">Showing <b>8</b> of <b>18</b> Results</p>
                </div>
    ...
    <div id="addDocuments" modal-center
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md flex flex-col h-full">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="#!">
                    ...
                    <div>
                        ...
                        <div
                            class="flex items-center justify-center border rounded-md cursor-pointer dropzone border-slate-200">
                            <div class="fallback">
                            ...
                            <div class="w-full py-5 text-lg text-center dz-message needsclick">
                                <div class="mb-3">
                                    <i data-lucide="upload-cloud"
                                        class="block size-12 mx-auto text-slate-500 fill-slate-200"></i>
                                </div>

                                <h5 class="mb-0 font-normal text-slate-500 text-15">Drag and drop your
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        <button type="reset" data-modal-close="addDocuments"
                            class="text-red-500 bg-red-100 btn hover:text-white hover:bg-red-600 focus:text-white focus:bg-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:ring active:ring-red-100">Cancel</button>
                        <button type="submit"
                            class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100">Add
                            Document</button>
                    </div>
