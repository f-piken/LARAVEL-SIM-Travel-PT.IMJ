...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="#!">
                <h6 class="mb-4 text-gray-800 underline text-16">Generale Info:</h6>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full whitespace-nowrap">
                        <thead>
                            <tr>
                                <th
                                    class="px-3.5 py-2.5 font-medium text-sm text-slate-500 uppercase border border-slate-200">
                                    Item Name</th>
                                <th
                                    class="px-3.5 py-2.5 font-medium text-sm text-slate-500 uppercase border border-slate-200">
                                    Quantity</th>
                                ...
                                <th
                                    ...
                                    TAX</th>
                                <th
                                    class="px-3.5 py-2.5 font-medium text-sm text-slate-500 uppercase border border-slate-200 w-44">
                                    Total</th>
                            </tr>
                        </thead>
                            ...
                            <tr class="item">
                                <td class="border border-slate-200">
                                    <input type="text" id="itemName1"
                                        class="px-3.5 py-2.5 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
                                        placeholder="Item Name" required>
                                </td>
                                <td class="w-40 border border-slate-200">
                                    <div class="flex justify-center text-center input-step">
                                        <button type="button"
                                            class="border size-9 leading-[15px] btn-minus bg-white ltr:rounded-l rtl:rounded-r transition-all duration-200 ease-linear border-slate-200 text-slate-500 hover:bg-custom-500 hover:text-custom-50 hover:border-custom-500 focus:bg-custom-500 focus:border-custom-500 focus:text-custom-50"><i
                                                data-lucide="minus" class="inline-block size-4"></i></button>
                                        <input type="number"
                                            class="w-12 text-center ltr:pl-2 rtl:pr-2 h-9 border-y product-quantity focus:shadow-none item-quantity"
                                            value="0" min="0" max="100" readonly="">
                                        <button type="button"
                                            class="transition-all duration-200 ease-linear bg-white border ltr:rounded-r rtl:rounded-l size-9 border-slate-200 btn-plus text-slate-500 hover:bg-custom-500 hover:text-custom-50 hover:border-custom-500 focus:bg-custom-500 focus:border-custom-500 focus:text-custom-50"><i
                                                data-lucide="plus" class="inline-block size-4"></i></button>
                                    </div>
                                </td>
                                <td class="w-40 border border-slate-200">
                                    <input type="number" id="itemName1"
                                        class="px-3.5 py-2.5 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 item-price"
                                        placeholder="$00.00" required>
                                </td>
                                <td class="w-40 border border-slate-200">
                                    <input type="text" id="itemName1"
                                        class="px-3.5 py-2.5 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 item-discount"
                                        placeholder="0%" required>
                                </td>
                                <td class="w-40 border border-slate-200">
                                    <input type="text" id="itemName1"
                                        class="px-3.5 py-2.5 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 item-text"
                                        placeholder="0%" required>
                                </td>
                                <td class="border border-slate-200" rowspan="2">
                                    <div class="mb-1">
                                        <input type="text" id="ItemTotal"
                                            class="px-3.5 py-2.5 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 item-line-price"
                                            placeholder="$00.00" readonly>
                                    </div>
                                    <input type="text" id="itemDiscountsInput"
                                        class="px-3.5 pb-2.5 pt-0 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 cart-discount"
                                        placeholder="-$00.00" readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="border border-slate-200 px-3.5 py-1.5 text-center">
                                    <button type="button"
                                        class="px-2 py-1.5 text-xs text-red-500 bg-red-100 btn hover:text-white hover:bg-red-600 focus:text-white focus:bg-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:ring active:ring-red-100 product-removal"><i
                                            data-lucide="trash-2" class="inline-block size-3 mr-1 align-middle"></i>
                                        <span class="align-middle">Delete</span></button>
                                </td>
                                <td colspan="3" class="border border-slate-200"></td>
                            </tr>
                        </tbody>
                        <tbody class="before:block before:h-3 item-list">
                            <tr class="item">
                        ...
                        <tbody class="before:block before:h-3" id="totalAmount">
                            <tr>
                                <td colspan="4"></td>
                                <td
                                    class="border-b border-slate-200 px-3.5 py-2.5 text-slate-500">
                                    Sub Total
                                </td>
                                <td class="font-medium border-b border-slate-200">
                                    <input type="text" id="subTotale"
                                        class="px-3.5 py-2.5 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 cart-subtotal"
                                        placeholder="$00.00" readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="font-medium border-b border-slate-200">
                                    <input type="text" id="estimatedTax"
                                        class="px-3.5 py-2.5 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 cart-tax"
                                        placeholder="$00.00" readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="font-medium border-b border-slate-200 text-slate-500">
                                    <input type="text" id="itemDiscounts"
                                        class="px-3.5 py-2.5 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 cart-discount"
                                        placeholder="-$00.00" readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="font-medium border-b border-slate-200">
                                    <input type="text" id="shippingCharge"
                                        class="px-3.5 py-2.5 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 cart-shipping"
                                        placeholder="$00.00" readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="font-medium border-b border-slate-200">
                                    <input type="text" id="totalAmount"
                                        class="px-3.5 py-2.5 border-none form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400 cart-total"
                                        placeholder="$00.00" readonly>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                    ...
                    <div class="xl:col-span-3">
                        ...
                        <input type="text" id="totalPayment"
                            class=" tform-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"
                            placeholder="$00.00" required>
                    </div><!--end col-->
                    <div class="xl:col-span-12">
                ...
                <div class="flex justify-end gap-2 mt-5">
                    ...
                    <button type="button"
                        class="text-white bg-green-500 border-green-500 btn hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100"><i
