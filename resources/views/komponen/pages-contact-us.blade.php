...
@section('content')
    ...
    <div class="mx-auto mb-16 text-center xl:w-2/5">
        ...
        <p class="text-slate-500">Fill out the form and a member from our sales team will get back to you
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
        <div class="card">
            <div class="!px-6 card-body flex flex-col h-full">
                <div
                    class="flex items-center justify-center size-16 mx-auto text-xl bg-white rounded-full shadow -mt-14">
                    <i data-lucide="map-pin" class="text-sky-500 fill-sky-100"></i>
                </div>
                <div class="mt-5 text-center">
                    <h6 class="mb-2 text-16">Our Main Office</h6>
                    <p class="mb-5 text-slate-500">501, Powell Ave, Clarks Summit, Pennsylvania, United
                        States - 18411</p>

                </div>
                <div class="mt-auto text-center">
                    <a href="#!"
                        class="transition-all duration-200 ease-linear text-custom-500 hover:text-custom-800">Visit
        ...
        <div class="card">
            <div class="!px-6 card-body flex flex-col h-full">
                <div
                    class="flex items-center justify-center size-16 mx-auto text-xl bg-white rounded-full shadow -mt-14">
                    <i data-lucide="shopping-bag" class="text-purple-500 fill-purple-100"></i>
                </div>
                <div class="mt-5 text-center">
                    <h6 class="mb-2 text-16">Sales Team Support</h6>
                    <p class="mb-5 text-slate-500">tailwick@sales.com</p>

                </div>
                <div class="mt-auto text-center">
                    <a href="#!"
                        class="transition-all duration-200 ease-linear text-custom-500 hover:text-custom-800">Sales
        ...
        <div class="card">
            <div class="!px-6 card-body flex flex-col h-full">
                <div
                    class="flex items-center justify-center size-16 mx-auto text-xl bg-white rounded-full shadow -mt-14">
                    <i data-lucide="compass" class="text-orange-500 fill-orange-100"></i>
                </div>
                <div class="mt-5 text-center">
                    <h6 class="mb-2 text-16">Help & Support</h6>
                    <p class="mb-1 text-slate-500">tailwick@support.com</p>
                    <p class="mb-5 text-slate-500">www.tailwick.com</p>

                </div>
                <div class="mt-auto text-center">
                    <a href="#!"
                        class="transition-all duration-200 ease-linear text-custom-500 hover:text-custom-800">Contact
                        Support <i data-lucide="move-right"
                            class="inline-block size-4 ltr:ml-1 rtl:mr-1 rtl:rotate-180"></i></a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="!px-6 card-body flex flex-col h-full">
                <div
                    class="flex items-center justify-center size-16 mx-auto text-xl bg-white rounded-full shadow -mt-14">
                    <i data-lucide="user-square" class="text-custom-500 fill-custom-100"></i>
                </div>
                <div class="mt-5 text-center">
                    <h6 class="mb-2 text-16">Email & Phone</h6>
                    <p class="mb-1 text-slate-500">tailwick@email.com</p>
                    <p class="mb-5 text-slate-500">(570) 586 2588</p>
    ...
    <div class="card">
        <div class="card-body">
            <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                <div class="xl:col-span-3 bg-custom-900 card !mb-0">
                    <div class="flex flex-col h-full card-body">
                        ...
                        <div class="mt-auto">
                            <ul class="flex flex-wrap items-center justify-center gap-2">
                                <li>
                                    <a href="#!"
                                        class="flex items-center justify-center size-10 transition-all duration-200 ease-linear rounded-md bg-custom-800/50 text-custom-300 hover:text-white">
