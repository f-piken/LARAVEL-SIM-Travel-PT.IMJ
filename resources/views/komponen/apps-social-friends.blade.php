        ...
        <div class="xl:col-span-9" id="friendList">
            <div class="flex items-center gap-3">
                ...
                <div class="shrink-0">
                    <div class="relative dropdown sortble-dropdown">
                        ...
                        <ul class="absolute z-50 hidden py-2 mt-1 text-left list-none bg-white rounded-md shadow-md dropdown-menu min-w-[9rem]"
                            aria-labelledby="dropdownMenuButton">
                            <li>
                                <a data-sort="friend_name"
                                    class="block dropdown-item px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500"
                                    href="#!">Name</a>
                            </li>
                            <li>
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-separate table-custom border-spacing-y-2 whitespace-nowrap">
                    <thead class="ltr:text-left rtl:text-right">
                        <tr class="relative bg-white rounded-md">
                    ...
                    <tbody class="list">
                        <tr class="relative bg-white rounded-md">
                            ...
                            <td class="px-3.5 py-2.5">
                                <button type="button"
                                    class="bg-white border-dashed group/item status toggle-button active text-sky-500 btn border-sky-500 hover:text-sky-500 hover:bg-sky-50 hover:border-sky-600 focus:text-sky-600 focus:bg-sky-50 focus:border-sky-600 active:text-sky-600 active:bg-sky-50 active:border-sky-600 px-2 py-1.5 text-xs">
                        ...
                        <tr class="relative bg-white rounded-md">
                            ...
                            <td class="px-3.5 py-2.5">
                                <button type="button"
                                    class="bg-white border-dashed group/item toggle-button status text-sky-500 btn border-sky-500 hover:text-sky-500 hover:bg-sky-50 hover:border-sky-600 focus:text-sky-600 focus:bg-sky-50 focus:border-sky-600 active:text-sky-600 active:bg-sky-50 active:border-sky-600 px-2 py-1.5 text-xs">
                                    <span class="group-[.active]/item:hidden block"><i data-lucide="plus"
                                            class="inline-block size-3 mr-1"></i> Follow</span>
                                    <span class="group-[.active]/item:block hidden"><i data-lucide="user-x-2"
                                            class="inline-block size-3 mr-1"></i> Unfollow</span>
                        ...
                        <tr class="relative bg-white rounded-md">
                            ...
                            <td class="px-3.5 py-2.5">
                                <button type="button"
                                    class="bg-white border-dashed group/item toggle-button status active text-sky-500 btn border-sky-500 hover:text-sky-500 hover:bg-sky-50 hover:border-sky-600 focus:text-sky-600 focus:bg-sky-50 focus:border-sky-600 active:text-sky-600 active:bg-sky-50 active:border-sky-600 px-2 py-1.5 text-xs">
                                    <span class="group-[.active]/item:hidden block"><i data-lucide="plus"
                                            class="inline-block size-3 mr-1"></i> Follow</span>
                                    <span class="group-[.active]/item:block hidden"><i data-lucide="user-x-2"
                                            class="inline-block size-3 mr-1"></i> Unfollow</span>
            ...
            <div class="flex flex-col items-center mt-4 mb-5 md:flex-row">
                <div class="mb-4 grow md:mb-0">
                    <p class="text-slate-500">Showing <b>12</b> of <b>44</b> Results</p>
                </div>
