            ...
            <div class="sticky card print:hidden top-[calc(theme('spacing.header')_+_theme('spacing.5'))]">
                <div class="card-body">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button type="button"
                            class="flex items-center justify-center size-[37.5px] p-0 text-sky-500 btn bg-sky-100 hover:text-white hover:bg-sky-600 focus:text-white focus:bg-sky-600 focus:ring focus:ring-sky-100 active:text-white active:bg-sky-600 active:ring active:ring-sky-100"><i
                ...
                <div data-simplebar
                    ...
                    <a href="#!"
                        class="block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100 active">
                        <div class="float-right">
                            <span
                                class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-yellow-100 border-transparent text-yellow-500">Unpaid</span>
                        </div>
                        <h6>#TW15090251</h6>
                        <div class="flex">
                            <div class="grow">
                                <h6 class="mt-3 mb-1 text-16">Paula Keenan</h6>
                                <p class="text-slate-500">$873.96</p>
                            </div>
                            <p class="self-end mb-0 text-slate-500 shrink-0"><i
                                    data-lucide="calendar-clock" class="inline-block size-4 ltr:mr-1 rtl:ml-1"></i> <span
                                    class="align-middle">21 Jan, 2024</span></p>
                        </div>
                    </a>
                    <a href="#!"
                        class="block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100">
                        <div class="float-right">
                            <span
                                class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-green-100 border-transparent text-green-500">Paid</span>
                        </div>
                        <h6>#TW15090252</h6>
                        <div class="flex">
                            <div class="grow">
                                <h6 class="mt-3 mb-1 text-16">Jaqueline Hammes</h6>
                                <p class="text-slate-500">$1,203.74</p>
                            </div>
                            <p class="self-end mb-0 text-slate-500 shrink-0"><i
                                    data-lucide="calendar-clock" class="inline-block size-4 ltr:mr-1 rtl:ml-1"></i> <span
                    ...
                    <a href="#!"
                        ...
                        <div class="flex">
                            <div class="grow">
                                ...
                                <p class="text-slate-500">$1,423.10</p>
                            </div>
                            <p class="self-end mb-0 text-slate-500 shrink-0"><i
                                    data-lucide="calendar-clock" class="inline-block size-4 ltr:mr-1 rtl:ml-1"></i> <span
                    ...
                    <a href="#!"
                        ...
                        <div class="float-right">
                            <span
                                class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-red-100 border-transparent text-red-500">Cancel</span>
                        </div>
                        <h6>#TW15090254</h6>
                        <div class="flex">
                            <div class="grow">
                                <h6 class="mt-3 mb-1 text-16">Stephon Trantow</h6>
                                <p class="text-slate-500">$1,420.99</p>
                            </div>
                            <p class="self-end mb-0 text-slate-500 shrink-0"><i
                                    data-lucide="calendar-clock" class="inline-block size-4 ltr:mr-1 rtl:ml-1"></i> <span
                    ...
                    <a href="#!"
                        ...
                        <div class="float-right">
                            <span
                                class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-slate-100 border-transparent text-slate-500">Refund</span>
                        </div>
                        <h6>#TW15090255</h6>
                        <div class="flex">
                            <div class="grow">
                                <h6 class="mt-3 mb-1 text-16">Domenic Tromp</h6>
                                <p class="text-slate-500">$247.18</p>
                            </div>
                            <p class="self-end mb-0 text-slate-500 shrink-0"><i
                                    data-lucide="calendar-clock" class="inline-block size-4 ltr:mr-1 rtl:ml-1"></i> <span
                    ...
                    <a href="#!"
                        ...
                        <div class="flex">
                            <div class="grow">
                                ...
                                <p class="text-slate-500">$559.32</p>
                            </div>
                            <p class="self-end mb-0 text-slate-500 shrink-0"><i
                                    data-lucide="calendar-clock" class="inline-block size-4 ltr:mr-1 rtl:ml-1"></i> <span
                    ...
                    <a href="#!"
                        ...
                        <div class="flex">
                            <div class="grow">
                                ...
                                <p class="text-slate-500">$2,147.65</p>
                            </div>
                            <p class="self-end mb-0 text-slate-500 shrink-0"><i
                                    data-lucide="calendar-clock" class="inline-block size-4 ltr:mr-1 rtl:ml-1"></i> <span
        ...
        <div class="xl:col-span-9">
            <div class="card print:shadow-none print:border-none">
                ...
                <div class="!pt-0 card-body">
                    <div class="p-5 rounded-md md:p-8 bg-slate-50 print:p-0">
                        ...
                        <div
                            ...
                            <div class="p-3">
                                ...
                                <p class="text-slate-500">Create Date</p>
                            </div><!--end col-->
                            <div class="p-3">
                                <h6 class="mb-1"><span
                                        class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-green-100 border-transparent text-green-500">Paid</span>
                        ...
                        <div class="grid grid-cols-1 gap-5 mt-8 md:grid-cols-2">
                            <div>
                                <p class="mb-2 text-sm uppercase text-slate-500">Shipping Address</p>
                            ...
                            <div>
                                <p class="mb-2 text-sm uppercase text-slate-500">Billing Address</p>
                                <h6 class="mb-1 text-15">Paula Keenan</h6>
                                <p class="mb-1 text-slate-500">176 Arvid Crest Sheastad, IA</p>
                                <p class="mb-1 text-slate-500">+(211) 0123 456 897</p>
                        ...
                        <div class="mt-6 overflow-x-auto">
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">1</td>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">
                                            <h6 class="mb-1">Webadmin - Premium Admin & Dashboard</h6>
                                            <p class="text-slate-500">Build with Bootstrap, React JS,
                                                Angular, Vue etc.</p>
                                        </td>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">$24.00
                                        </td>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">2</td>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">$48</td>
                                    </tr>
                                    <tr>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">2</td>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">
                                        ...
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">$25.00
                                        </td>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">4</td>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">$100</td>
                                    </tr>
                                    <tr>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">1</td>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">
                                        ...
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">$16.00
                                        </td>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">9</td>
                                        <td class="px-3.5 py-2.5 border-b border-slate-200">$144</td>
                                    </tr>
                                </tbody>
                                <tbody class="before:block before:h-3">
                                    ...
                                    <tr>
                                        <td colspan="3"></td>
                                        <td
                                            class="border-b border-slate-200 px-3.5 py-2.5 font-medium">
                                            Total Amount
                                        </td>
                                        <td
                                            class="border-b border-slate-200 px-3.5 py-2.5 font-medium">
                        ...
                        <div class="my-5">
                            ...
                            <p class="mb-0 text-slate-500">Total Amount: $755.96</p>
                        </div>
