...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-12">
        <div class="xl:col-span-4">
            <div class="sticky top-[calc(theme('spacing.header')_*_1.3)] mb-5">
                <div class="card">
                    <div class="card-body">
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-12">
                            <div class="rounded-md md:col-span-8 md:row-span-2 bg-slate-100">
                                <img src="{{ URL::asset('build/images/product/overview-01.png') }}" alt="">
                            </div>
                            <div class="rounded-md md:col-span-4 bg-slate-100">
                                <img src="{{ URL::asset('build/images/product/overview-02.png') }}" alt="">
                            </div>
                            <div class="p-4 rounded-md md:col-span-4 bg-slate-100">
                        ...
                        <div class="flex gap-2 mt-4 shrink-0">
                            <a href="{{ url('apps-ecommerce-cart') }}" type="button"
                                class="w-full bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600"><i
                                    data-lucide="shopping-cart"
                                    class="inline-block size-3 align-middle ltr:mr-1 rtl:ml-1"></i> <span
                                    class="align-middle">Add to Cart</span></a>
                            <button type="button"
                                class="w-full text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100">Buy
                                Now</button>
                        </div>
                ...
                <div class="card">
                    <div class="border-b card-body border-slate-200">
                        <div class="flex">
        ...
        <div class="xl:col-span-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <span
                        class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-sky-100 border-sky-100 text-sky-500">
                        New Arrivals</span>
                    <h5 class="mt-3 mb-1">Smartees Printed Men Round Neck Pink</h5>
                    <ul class="flex flex-wrap items-center gap-4 mb-5 text-slate-500">
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-4">
                        <div class="flex items-center gap-2 text-yellow-500">
                            ...
                            <div class="text-slate-800 shrink-0">
                                <h6>(4.8)</h6>
                            </div>
                        </div>
                        <div class="shrink-0">
                    ...
                    <div class="mb-4">
                        ...
                        <h4>$487.32 <small
                                class="font-normal line-through align-middle text-slate-500">$599.99</small>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <div>
                            ...
                            <label for="selectSize2XL"
                                class="flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 peer-checked:bg-custom-50 peer-checked:border-custom-300 peer-disabled:bg-slate-50 peer-disabled:border-slate-100 peer-disabled:cursor-default peer-disabled:text-slate-500">2XL</label>
                        </div>
                    </div>
                    ...
                    <ul class="flex flex-col gap-2">
                        <li><i data-lucide="tag"
                                class="inline-block size-4 text-green-500 ltr:mr-1 rtl:ml-1 fill-green-200"></i>
                    ...
                    <div class="grid grid-cols-1 gap-5 my-5 xl:grid-cols-3">
                        <div class="flex items-center gap-5 p-4 border rounded-md border-slate-200">
                            <div class="flex items-center justify-center">
                                <i data-lucide="truck"
                                    class="size-6 text-slate-500 fill-slate-200"></i>
                            </div>
                            <div>
                        ...
                        <div class="flex items-center gap-5 p-4 border rounded-md border-slate-200">
                            ...
                            <div>
                                ...
                                <p class="text-slate-500">On all orders over $200.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <p class="mb-2 text-slate-500">Latest <b>Trends</b> in Fashion Clothing.
                        ...
                        <p class="text-slate-500"><b>Avoid shapeless and baggy clothing</b>. Stay away
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                <tbody>
                                    <tr>
                                        <th
                                            class="px-3.5 py-2.5 font-semibold border-b border-transparent w-64 ltr:text-left rtl:text-right text-slate-500">
                                            Type</th>
                    ...
                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                        <div class="xl:col-span-4">
                            <div class="border border-dashed rounded-md border-slate-200">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h5 class="mb-2 text-16">Customer Ratings</h5>
                                        <span
                                            class="px-3.5 py-1.5 inline-flex gap-3 text-xs font-medium rounded-full border bg-slate-100 border-slate-100 text-slate-500">
                                        ...
                                        <p class="mt-2 text-sm text-slate-500">4,213 total ratings</p>
                                    </div>
                        ...
                        <div class="xl:col-span-8">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="size-10 rounded-full shrink-0 bg-sky-100">
                                        <img src="{{ URL::asset('build/images/users/avatar-2.png') }}" alt=""
                                            class="h-10 rounded-full">
                                    </div>
                                    <div class="grow">
                                        <h6 class="text-15"><a href="#!">Aubrey Beer</a></h6>
                                        <p class="text-sm text-slate-500">on 14 Jan, 2024</p>
                                    </div>
                                </div>
                                ...
                                <p class="text-slate-500">"Nice product good quality and looking"</p>
                            ...
                            <div class="pt-3 mt-3 border-t border-slate-200">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="grow">
                                        ...
                                        <p class="text-sm text-slate-500">on 20 July, 2023</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-2 mt-4 mb-2 text-yellow-500">
                                    <i class="ri-star-fill"></i>
                                ...
                                <p class="text-slate-500">"Amazing! Fast, to the point, professional and
                            ...
                            <div class="pt-3 mt-3 border-t border-slate-200">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="grow">
                                        ...
                                        <p class="text-sm text-slate-500">on 07 Dec, 2023</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-2 mt-4 mb-2 text-yellow-500">
                                    <i class="ri-star-fill"></i>
                                ...
                                <p class="text-slate-500">"Very nice design. Clean Code and easy
                                    customizable"</p>
                                <div class="flex items-center gap-3 mt-3">
                                    <a href="#!"
                                        class="text-slate-500 shrink-0 count-button [&.active]:text-green-500 active"><i
                            ...
                            <div class="pt-3 mt-3 border-t border-slate-200">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="grow">
                                        ...
                                        <p class="text-sm text-slate-500">on 10 Aug, 2023</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-2 mt-4 mb-2 text-yellow-500">
                                    <i class="ri-star-fill"></i>
                                ...
                                <p class="text-slate-500">"The best templates which is supported
    ...
    <div id="addReviewsModal" modal-center
        ...
        <div class="w-screen lg:xl:w-[55rem] bg-white shadow rounded-md">
        ...
        <div class="w-screen md:w-[25rem] bg-white shadow rounded-md">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                ...
                <ul class="flex gap-2 item-center">
                    <li><a href="#!"
                            class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-9 text-slate-500 bg-slate-100 hover:bg-custom-100 hover:text-custom-500"><i
