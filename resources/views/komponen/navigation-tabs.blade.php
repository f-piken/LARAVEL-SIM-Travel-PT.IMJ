    ...
    <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-2">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <ul
                        class="flex flex-wrap w-full text-sm font-medium text-center border-b border-slate-200 nav-tabs">
                        <li class="group active">
                            <a href="javascript:void(0);" data-tab-toggle data-target="home"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border border-transparent group-[.active]:text-custom-500 group-[.active]:border-slate-200 group-[.active]:border-b-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Home</a>
                        </li>
                        <li class="group">
                            <a href="javascript:void(0);" data-tab-toggle data-target="Profile"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border border-transparent group-[.active]:text-custom-500 group-[.active]:border-slate-200 group-[.active]:border-b-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Profile</a>
                        </li>
                        <li class="group">
                            <a href="javascript:void(0);" data-tab-toggle data-target="setting"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border border-transparent group-[.active]:text-custom-500 group-[.active]:border-slate-200 group-[.active]:border-b-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Settings</a>
                        </li>
                        <li class="group">
                            <a href="javascript:void(0);" data-tab-toggle data-target="contact"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border border-transparent group-[.active]:text-custom-500 group-[.active]:border-slate-200 group-[.active]:border-b-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Contacts</a>
                        </li>
                    </ul>
                    ...
                    <ul
                        ...
                        <li class="group grow active">
                            <a href="javascript:void(0);" data-tab-toggle data-target="homeJustified"
                                class="inline-block px-4 py-2 text-base w-full transition-all duration-300 ease-linear rounded-t-md text-slate-500 border border-transparent group-[.active]:text-custom-500 group-[.active]:border-slate-200 group-[.active]:border-b-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Home</a>
                        </li>
                        <li class="group grow">
                            <a href="javascript:void(0);" data-tab-toggle data-target="ProfileJustified"
                                class="inline-block px-4 py-2 text-base w-full transition-all duration-300 ease-linear rounded-t-md text-slate-500 border border-transparent group-[.active]:text-custom-500 group-[.active]:border-slate-200 group-[.active]:border-b-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Profile</a>
                        </li>
                        <li class="group grow">
                            <a href="javascript:void(0);" data-tab-toggle data-target="settingJustified"
                                class="inline-block px-4 py-2 text-base w-full transition-all duration-300 ease-linear rounded-t-md text-slate-500 border border-transparent group-[.active]:text-custom-500 group-[.active]:border-slate-200 group-[.active]:border-b-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Settings</a>
                        </li>
                        <li class="group grow">
                            <a href="javascript:void(0);" data-tab-toggle data-target="contactJustified"
                                class="inline-block px-4 py-2 text-base w-full transition-all duration-300 ease-linear rounded-t-md text-slate-500 border border-transparent group-[.active]:text-custom-500 group-[.active]:border-slate-200 group-[.active]:border-b-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Contacts</a>
                        </li>
                    </ul>
                    ...
                    <ul class="flex flex-wrap w-full text-sm font-medium text-center nav-tabs">
                        <li class="group active">
                            <a href="javascript:void(0);" data-tab-toggle data-target="homePill"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Home</a>
                        </li>
                        <li class="group">
                            <a href="javascript:void(0);" data-tab-toggle data-target="profilePill"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Profile</a>
                        </li>
                        <li class="group">
                            <a href="javascript:void(0);" data-tab-toggle data-target="settingPill"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Settings</a>
                        </li>
                        <li class="group">
                            <a href="javascript:void(0);" data-tab-toggle data-target="contactPill"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Contacts</a>
                        </li>
                    </ul>
                    ...
                    <ul class="flex flex-wrap w-full text-sm font-medium text-center nav-tabs">
                        <li class="group grow active">
                            <a href="javascript:void(0);" data-tab-toggle data-target="homePillJustified"
                                class="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Home</a>
                        </li>
                        <li class="group grow ">
                            <a href="javascript:void(0);" data-tab-toggle data-target="profilePillJustified"
                                class="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Profile</a>
                        </li>
                        <li class="group grow ">
                            <a href="javascript:void(0);" data-tab-toggle data-target="settingPillJustified"
                                class="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Settings</a>
                        </li>
                        <li class="group grow ">
                            <a href="javascript:void(0);" data-tab-toggle data-target="contactPillJustified"
                                class="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px]">Contacts</a>
                        </li>
                    </ul>
                    ...
                    <ul
                        ...
                        <li class="group active">
                            <a href="javascript:void(0);" data-tab-toggle data-target="homeSimple"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 -mb-[1px]">Home</a>
                        </li>
                        <li class="group">
                            <a href="javascript:void(0);" data-tab-toggle data-target="ProfileSimple"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 -mb-[1px]">Profile</a>
                        </li>
                        <li class="group">
                            <a href="javascript:void(0);" data-tab-toggle data-target="settingSimple"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 -mb-[1px]">Settings</a>
                        </li>
                        <li class="group">
                            <a href="javascript:void(0);" data-tab-toggle data-target="contactSimple"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 -mb-[1px]">Contacts</a>
                        </li>
                    </ul>
                    ...
                    <ul
                        ...
                        <li class="group active">
                            <a href="javascript:void(0);" data-tab-toggle data-target="homeBorderTop"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border border-transparent border-t-2 group-[.active]:text-red-500 group-[.active]:border-slate-200 group-[.active]:border-t-red-500 group-[.active]:border-b-white hover:text-red-500 active:text-red-500 -mb-[1px]">Home</a>
                        </li>
                        <li class="group">
                    ...
                    <ul
                        ...
                        <li class="group active">
                            <a href="javascript:void(0);" data-tab-toggle data-target="homeIcon"
                                class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 border border-transparent group-[.active]:text-custom-500 group-[.active]:border-slate-200 group-[.active]:border-b-white hover:text-custom-500 active:text-custom-500 -mb-[1px]"><i
                    ...
                    <ul class="flex flex-wrap w-full text-sm font-medium text-center nav-tabs">
                        <li class="group grow active">
                            <a href="javascript:void(0);" data-tab-toggle data-target="homeArrow"
                                class="relative inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 border border-transparent group-[.active]:bg-custom-500 group-[.active]:text-white hover:text-custom-500 active:text-custom-500 -mb-[1px] before:absolute before:-bottom-1.5 before:-rotate-[135deg] before:left-2/4 before:-translate-x-2/4 before:bg-transparent group-[.active]:before:bg-custom-500 before:h-3 before:w-3">Home</a>
                        </li>
                        <li class="group grow ">
                ...
                <div class="gap-4 md:flex">
                    ...
                    <div class="tab-content">
                        <div class="block tab-pane" id="homeVertical">
                            <p class="flex gap-2 mb-2 text-slate-500"><i data-lucide="check-square"
                                ...
                                cleanse.</p>
                            <p class="flex gap-2 text-slate-500"><i data-lucide="check-square"
