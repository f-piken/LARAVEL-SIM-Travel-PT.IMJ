...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-2">
        <div class="card">
            <div class="card-body">
                <h6 class="mb-4 text-gray-800 text-15">Basic Dropdown</h6>
                <div class="flex flex-wrap items-center gap-2">
                    <div class="relative dropdown">
                        ...
                        <ul class="absolute z-50 hidden py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max"
                    ...
                    <div class="relative dropdown">
                        <a href="#!"
                            class="bg-white border-white dropdown-toggle text-custom-500 btn hover:text-custom-700 focus:text-custom-700 active:text-custom-700"
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <div class="relative dropdown">
                        ...
                        <ul class="absolute z-50 hidden py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max"
                            ...
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-custom-500 dropdown-item hover:bg-custom-50 hover:text-custom-600 focus:bg-custom-50 focus:text-custom-600"
                                    href="#!">Action</a>
                            </li>
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-custom-500 dropdown-item hover:bg-custom-50 hover:text-custom-600 focus:bg-custom-50 focus:text-custom-600"
                    ...
                    <div class="relative dropdown">
                        ...
                        <ul class="absolute z-50 hidden py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max"
                            ...
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-green-500 dropdown-item hover:bg-green-50 hover:text-green-600 focus:bg-green-50 focus:text-green-600"
                                    href="#!">Action</a>
                            </li>
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-green-500 dropdown-item hover:bg-green-50 hover:text-green-600 focus:bg-green-50 focus:text-green-600"
                    ...
                    <div class="relative dropdown">
                        ...
                        <ul class="absolute z-50 hidden py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max"
                            ...
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-orange-500 dropdown-item hover:bg-orange-50 hover:text-orange-600 focus:bg-orange-50 focus:text-orange-600"
                                    href="#!">Action</a>
                            </li>
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-orange-500 dropdown-item hover:bg-orange-50 hover:text-orange-600 focus:bg-orange-50 focus:text-orange-600"
                    ...
                    <div class="relative dropdown">
                        ...
                        <ul class="absolute z-50 hidden py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max"
                            ...
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-yellow-500 dropdown-item hover:bg-yellow-50 hover:text-yellow-600 focus:bg-yellow-50 focus:text-yellow-600"
                                    href="#!">Action</a>
                            </li>
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-yellow-500 dropdown-item hover:bg-yellow-50 hover:text-yellow-600 focus:bg-yellow-50 focus:text-yellow-600"
                    ...
                    <div class="relative dropdown">
                        <button type="button"
                            class="text-white bg-red-500 border-red-500 dropdown-toggle btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100"
                        ...
                        <ul class="absolute z-50 hidden py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max"
                            ...
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-red-500 dropdown-item hover:bg-red-50 hover:text-red-600 focus:bg-red-50 focus:text-red-600"
                                    href="#!">Action</a>
                            </li>
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-red-500 dropdown-item hover:bg-red-50 hover:text-red-600 focus:bg-red-50 focus:text-red-600"
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="mb-4 text-gray-800 text-15">Dropdown Content</h6>
                <div class="flex flex-wrap items-center gap-2">
                    <div class="relative dropdown">
                        <button type="button"
                            class="text-white dropdown-toggle btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100"
                        ...
                        <ul class="absolute z-50 hidden py-2 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max"
                            ...
                            <li class="px-2 py-1 text-sm truncate text-slate-500">
                                Welcome to Tailwick
                            </li>
                            <li>
                                <a class="block px-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500"
                    ...
                    <div class="relative dropdown">
                        ...
                        <ul class="absolute z-50 hidden p-5 mt-1 list-none bg-white rounded-md shadow-md ltr:text-left rtl:text-right dropdown-menu min-w-max"
                            ...
                            <form action="#!">
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="inputText"
                                        class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300"
