...
@section('title')
    {{ __('Add Leave(Employee)') }}
@endsection
@section('content')
    <!-- page title -->
    <x-page-title title="Add Leave (Employee)" pagetitle="Leaves Manage" />
                ...
                <div class="card-body">
                    ...
                    <div>
                        <table class="w-full mb-0">
                            <tbody>
                                <tr>
                                    <td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent">Medical Leave
                                    </td>
