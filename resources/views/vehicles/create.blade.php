            ...
            <form action="{{ route('vehicles.store') }}" method="POST">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <label class="inline-flex items-center">
                        <input type="checkbox" id="checkAllSurat" class="form-checkbox">
                        <span class="ml-2">Check All</span>
                    </label>
                    @foreach(['stnk', 'buku_kir', 'kartu_tap_oli'] as $detail)
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="{{ $detail }}" value="1" class="form-checkbox checkSurat">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <label class="inline-flex items-center">
                        <input type="checkbox" id="checkAllPeralatan" class="form-checkbox">
                        <span class="ml-2">Check All</span>
                    </label>
                    @foreach(['dongkrak', 'ban_serep', 'kunci_roda'] as $detail)
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="{{ $detail }}" value="1" class="form-checkbox checkPeralatan">
                            <span class="ml-2 capitalize">{{ str_replace('_', ' ', $detail) }}</span>
                        </label>
                    @endforeach
                </div>
                ...
                <div class="grid grid-cols-3 gap-4">
                    <label class="inline-flex items-center">
                        <input type="checkbox" id="checkAllKelistrikan" class="form-checkbox">
                        <span class="ml-2">Check All</span>
                    </label>
                    @foreach(['lampu_utama', 'lampu_belakang', 'lampu_sein', 'lampu_dalam', 'lcd', 'ac'] as $detail)
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="{{ $detail }}" value="1" class="form-checkbox checkKelistrikan">
                            <span class="ml-2 capitalize">{{ str_replace('_', ' ', $detail) }}</span>
                        </label>
                    @endforeach
                </div>
