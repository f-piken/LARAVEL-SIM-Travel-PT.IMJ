...
<div class="card" id="serviceList">
    <div class="card-body">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-5">
            ...
            <form action="{{ route('services.index') }}" method="GET" class="flex items-center gap-2">
                <div class="flex border border-slate-200 rounded-md overflow-hidden">
                    <select name="month" class="form-select border-none focus:outline-none focus:ring-0 disabled:bg-slate-100 px-3 py-2">
                    ...
                    <select name="year" class="form-select border-none focus:outline-none focus:ring-0 disabled:bg-slate-100 px-3 py-2">
                ...
                <table class="w-full whitespace-nowrap" id="serviceTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200">{{ $item->total }}</td>
