    ...
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md">
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
            <form action="{{ route('users.store') }}" method="POST">
                @csrf
                <h2 class="text-lg font-bold mb-4">User and User Information</h2>
                ...
                <div class="grid gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" class="form-input w-full border-slate-200" placeholder="Boleh Kosong">
                    </div>

                    <div>
                        <label for="phone" class="block font-medium">Phone</label>
                        <input type="text" id="phone" name="phone" required class="form-input w-full border-slate-200" placeholder="Boleh Kosong">
                    </div>

                    <div>
                        <label for="position" class="block font-medium">Position</label>
                        <input type="text" id="position" name="position" class="form-input w-full border-slate-200">
                    </div>

                    <div>
                        <label for="salary" class="block font-medium">Salary</label>
                        <input type="number" id="salary" name="salary" class="form-input w-full border-slate-200">
                    </div>
                </div>
                ...
                <div class="grid gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" id="username" name="username" required class="form-input w-full border-slate-200">
                    </div>

                    <div>
                        <label for="password" class="block font-medium">Password <span class="text-red-500">*</span></label>
                        <input type="password" id="password" name="password" required class="form-input w-full border-slate-200">
                    </div>

                    <div>
                        <label for="role" class="block font-medium">Role</label>
                        <select id="role" name="role" class="form-select w-full border-slate-200">
